package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class AddFriendsEntityTab extends Tab
   {
      ...
      private static const const_1319:String = "addFriendsEntityTabXML";
      ...
      {
         super();
         _window = var_1305.buildFromXML(var_859.getAssetByName(const_1319).content as XML) as IWindowContainer;
         _window.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMouseClick);
         var _loc1_:IBitmapWrapperWindow = _window.findChildByName(const_1320) as IBitmapWrapperWindow;
         _loc1_.disposesBitmap = false;
         _loc1_.bitmap = var_859.getAssetByName(const_1318).content as BitmapData;
