package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_283:Boolean = false;
      
      private static const const_613:String = "FriendBar";
      
      private static const const_614:String = "user_interaction";
      
      private static const TRACKING_EVENT_ACTION_VISIT:String = "visit_btn_click";
      
      private static const const_1268:String = "chat_btn_click";
      
      private static const const_1269:String = "find_friends_btn_click";
       
      
      private var var_194:IHabboCommunicationManager;
      
      private var var_879:IHabboMessenger;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            if(this.var_194)
            {
               this.var_194.release(new IIDHabboCommunicationManager());
               this.var_194 = null;
            }
            if(this.var_879)
            {
               this.var_879.release(new IIDHabboMessenger());
               this.var_879 = null;
            }
            this.var_128 = null;
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_194)
         {
            this.var_194.getHabboMainConnection(null).send(new FollowFriendMessageComposer(param1));
            this.var_194.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_613,const_614,TRACKING_EVENT_ACTION_VISIT));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_879)
         {
            this.var_879.startConversation(param1);
            if(this.var_194)
            {
               this.var_194.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_613,const_614,const_1268));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_194)
         {
            this.var_194.getHabboMainConnection(null).send(new FindNewFriendsMessageComposer());
            this.var_194.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_613,const_614,const_1269));
         }
      }
      
      private function onCommunicationManagerAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_194 = param2 as IHabboCommunicationManager;
         this.var_194.addHabboConnectionMessageEvent(new MessengerInitEvent(this.onMessengerInitialized));
         this.var_194.addHabboConnectionMessageEvent(new FriendListUpdateEvent(this.onFriendListUpdate));
         this.var_194.addHabboConnectionMessageEvent(new FindFriendsProcessResultEvent(this.onFindFriendProcessResult));
      }
      
      private function onMessengerComponentAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_879 = param2 as IHabboMessenger;
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         for each(_loc4_ in _loc6_)
         {
            ...
            else if(_loc4_.online || const_283)
            {
         ...
         {
            this.var_128 = !!const_283 ? this.sortByNameAndOnlineStatus(this.var_128) : this.sortByName(this.var_128);
         }
         events.dispatchEvent(new FriendBarUpdateEvent(FriendBarUpdateEvent.const_458));
      }
