package com.sulake.habbo.quest
{
   ...
   public class IncomingMessages implements IDisposable
   {
      ...
      public function IncomingMessages(param1:HabboQuestEngine)
      {
         super();
         this.var_137 = param1;
         this._communication = this.var_137.communication;
      ...
      private function onQuestCompleted(param1:IMessageEvent) : void
      {
         ...
         new QuestCompleted(this.var_137,_loc2_.questData);
      }
      ...
      private function onQuests(param1:IMessageEvent) : void
      {
         ...
         this.var_137.controller.onQuests(_loc2_.quests,_loc2_.openWindow);
      }
      ...
      private function onQuest(param1:IMessageEvent) : void
      {
         ...
         this.var_137.controller.onQuest(_loc2_.quest);
      }
      ...
      {
         var _loc1_:String = this.var_137.configuration.getKey("questing.defaultCampaign","");
         var _loc2_:String = this.var_137.configuration.getKey("questing.defaultCampaign.override","");
         var _loc3_:String = this.var_137.configuration.getKey("questing.excludedCampaignCode","");
      ...
      {
         this.var_137.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_126,HabboToolbarIconEnum.QUESTS));
      }
      
      private function onRoomExit(param1:IMessageEvent) : void
      {
         this.var_137.controller.onRoomExit();
         this.var_137.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_166,HabboToolbarIconEnum.QUESTS));
      }
   }
}
