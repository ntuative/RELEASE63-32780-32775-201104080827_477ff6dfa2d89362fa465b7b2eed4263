package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1797:String = "no_reqs_info";
      ...
      private var var_1991:IContainerButtonWindow;
      
      private var var_1990:IContainerButtonWindow;
      ...
      {
         this.var_1991 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1990 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1990.procedure = this.onDismissAllButtonClick;
         this.var_1991.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_1085)
         {
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_418 && _loc4_.state != FriendRequest.const_371)
            {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1991,_loc1_);
         this.setEnabled(this.var_1990,_loc1_);
      }
