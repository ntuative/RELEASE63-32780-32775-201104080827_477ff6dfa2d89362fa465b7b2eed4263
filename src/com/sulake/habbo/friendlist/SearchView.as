package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      {
         this.var_837 = ITextFieldWindow(param1.findChildByName("search_str"));
         this.var_837.procedure = this.onSearchInput;
         this.var_837.addEventListener(WindowKeyboardEvent.const_182,this.onSearchStrInput);
