package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_840:ISessionDataManager;
      
      private var var_2819:FriendListLookAndFeel;
      
      private var var_436:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_2012:OpenedToWebPopup;
      
      private var var_2351:int;
      
      var var_99:FriendCategories;
      
      private var var_389:FriendRequests;
      
      private var var_2013:AvatarSearchResults;
      ...
      {
         this.var_2819 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_99 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_2013 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_675.stop();
            this.var_675.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_675 = null;
         }
         ...
         if(this.var_840)
         {
            this.var_840.release(new IIDSessionDataManager());
            this.var_840 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_2012 = new OpenedToWebPopup(this);
         }
         this.var_2012.show(x,y);
      }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(this.var_389.getCountOfOpenRequests() > 0 ? "2" : "0");
         this.var_160.events.dispatchEvent(_loc1_);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_313,HabboWindowStyle.const_43,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1122.createAvatarImage(param1,AvatarScaleType.const_87,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         this.var_160 = IHabboToolbar(param2) as IHabboToolbar;
      ...
      {
         this.var_840 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_389 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_99.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_99.addCategory(new FriendCategory(FriendCategory.const_1122,this.getText("friendlist.friends")));
         this.var_99.addCategory(new FriendCategory(FriendCategory.const_395,this.getText("friendlist.friends.offlinecaption")));
         ...
         if(!this.var_675)
         {
            this.var_675 = new Timer(120000);
            this.var_675.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_675.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this.var_160.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_126,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_99.findCategory(FriendCategory.const_395);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_389.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_389.addRequest(new FriendRequest(_loc3_));
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_389.addRequestAndUpdateView(_loc3_);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_2013.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         if(!this.var_840 || !this.var_389)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_840.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_47))
         {
            _loc2_ = this.var_389.vipLimit;
         }
         else if(this.var_840.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_44))
         {
            _loc2_ = this.var_389.clubLimit;
         }
         if(_loc2_ > this.var_389.limit)
         {
            this.var_389.limit = _loc2_;
         }
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ != null && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face != null)
               {
                  _loc4_ = _loc3_.view.getChildByName(const_178) as IBitmapWrapperWindow;
