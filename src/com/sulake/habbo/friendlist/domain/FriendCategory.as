package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_410:int = 100;
      ...
      {
         return Math.ceil(this.var_227.length / const_410);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_945 * const_410;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_945 + 1) * const_410,this.var_227.length);
      }
