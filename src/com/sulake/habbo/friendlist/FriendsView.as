package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_1831:String = "bg";
      ...
      private var var_2427:IContainerButtonWindow;
      ...
      {
         this.var_2428 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2429 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_2427 = this.initButton("room_invite",this.onInviteButtonClick,param1);
         this.var_2430 = this.initButton("remove_friend",this.onRemoveButtonClick,param1);
         this.refreshButtons();
      }
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2428,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2429,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2427,this.isEnableInviteButton(_loc1_));
         this.setEnabled(this.var_2430,this.isEnableRemoveButton(_loc1_));
      }
