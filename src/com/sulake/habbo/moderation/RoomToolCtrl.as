package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1450:ICheckBoxWindow;
      ...
      {
         return WindowTracker.const_1689;
      }
      ...
      public function populate() : void
      {
         ...
         this.var_1082 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1082);
         this.var_1082.procedure = this.onSelectTemplate;
         this.var_962 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1450 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1451 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_34,WindowTracker.const_670,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         this.var_34.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1522,_loc2_,this.var_483.text,"",""));
         if(this.var_1450.isSelected || this.var_1451.isSelected || this.var_962.isSelected)
         {
            this.var_34.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1450.isSelected,this.var_1451.isSelected,this.var_962.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1667);
         }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_34.initMsg.roomMessageTemplates[this.var_1082.selection];
         if(_loc3_ != null)
         {
            this.var_612 = false;
            this.var_483.text = _loc3_;
         }
      }
   }
}
