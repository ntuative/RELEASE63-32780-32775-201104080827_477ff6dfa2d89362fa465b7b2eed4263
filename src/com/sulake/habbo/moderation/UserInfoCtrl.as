package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_1023:int = 3600;
      
      private static const const_1022:int = 86400;
      
      private static const const_1021:int = 31536000;
      ...
      public static function method_3(param1:int) : String
      {
         if(param1 < 2 * const_1020)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_1023)
         {
            return Math.round(param1 / const_1020) + " mins ago";
         }
         if(param1 < 2 * const_1022)
         {
            return Math.round(param1 / const_1023) + " hours ago";
         }
         if(param1 < 2 * const_1021)
         {
            return Math.round(param1 / const_1022) + " days ago";
         }
         return Math.round(param1 / const_1021) + " years ago";
      }
      ...
      public function refresh() : void
      {
         ...
         this.setTxt(_loc1_,"registered_txt",method_3(this._data.minutesSinceRegistration * 60));
         this.setTxt(_loc1_,"last_login_txt",method_3(this._data.minutesSinceLastLogin * 60));
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1287.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_34.getXmlWindow("user_info"));
            this.var_1287.addChild(_loc1_);
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_34,WindowTracker.const_1154,this._data.userId),this._callerFrame,this.var_1288,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new SendMsgsCtrl(this.var_34,this._data.userId,this._data.userName,this.var_1351),this._callerFrame,this.var_1288,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new ModActionCtrl(this.var_34,this._data.userId,this._data.userName,this.var_1351),this._callerFrame,this.var_1288,false,true);
      }
