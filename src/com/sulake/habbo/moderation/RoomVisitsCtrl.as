package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1905:int = 200;
      ...
      {
         this.var_802 = IWindowContainer(this.var_34.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1539;
      }
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1497)
         {
