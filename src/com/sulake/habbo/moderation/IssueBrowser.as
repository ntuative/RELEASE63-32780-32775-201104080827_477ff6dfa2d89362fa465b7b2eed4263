package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2068:String = "open_issues";
      
      private const const_2070:String = "picked_issues";
      
      private const const_2078:String = "closed_issues";
      ...
      private var var_1918:IIssueBrowserView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_379.view.width = this.var_267.container.width;
         this.var_379.view.height = this.var_267.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2069:
               ...
               {
                  this.var_1918 = new MyIssuesView(this.issueManager,this,this.var_267.container);
               }
               return this.var_1918;
            case this.const_2068:
               if(this.var_1916 == null)
               {
                  this.var_1916 = new OpenIssuesView(this.issueManager,this,this.var_267.container);
               }
               return this.var_1916;
            case this.const_2070:
               if(this.var_1917 == null)
               {
                  this.var_1917 = new PickedIssuesView(this.issueManager,this,this.var_267.container);
               }
