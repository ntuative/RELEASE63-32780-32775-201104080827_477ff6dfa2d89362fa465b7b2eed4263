package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_146:IssueBundle;
      ...
      private function createView() : void
      {
         ...
         var _loc3_:IssueMessageData = this.var_146.getHighestPriorityIssue();
         this.var_475 = new UserInfoCtrl(this._window,this.var_64,_loc3_.message);
         this.var_1072 = new UserInfoCtrl(this._window,this.var_64,_loc3_.message);
         ...
         if(this.var_146.reportedUserId > 0)
         {
            this.var_1072.load(_loc4_,this.var_146.reportedUserId);
         }
         else
         {
         ...
         Logger.log("HARASSER: " + this.var_146.reportedUserId);
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc2_:Array = this.var_146.issues;
         var _loc3_:int = 0;
      ...
      {
         if(this.var_64 != null && this.var_64.issueManager != null && this.var_146 != null)
         {
            this.var_64.issueManager.removeHandler(this.var_146.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_64.issueManager.closeBundle(this.var_146.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_64.issueManager.closeBundle(this.var_146.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_64.issueManager.closeBundle(this.var_146.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_64.issueManager.releaseBundle(this.var_146.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = this.var_146.getHighestPriorityIssue().issueId;
         this.var_64.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_64,WindowTracker.const_1240,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            _loc3_ = this.var_146.getHighestPriorityIssue();
            this.var_475 = new UserInfoCtrl(this._window,this.var_64,_loc3_.message);
