package com.sulake.habbo.ui
{
   ...
   public class FurnitureTeaserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_720,RoomWidgetViralFurniMessage.const_889,RoomWidgetViralFurniMessage.const_168];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_720:
               ...
               break;
            case RoomWidgetViralFurniMessage.const_889:
      ...
      {
         return [RoomSessionViralFurniStatusEvent.const_481,RoomSessionViralFurniStatusEvent.const_527];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionViralFurniStatusEvent.const_481:
