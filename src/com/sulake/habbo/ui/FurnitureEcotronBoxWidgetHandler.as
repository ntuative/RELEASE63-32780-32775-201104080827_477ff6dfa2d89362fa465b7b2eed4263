package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_927,RoomWidgetEcotronBoxOpenMessage.const_894,RoomWidgetEcotronBoxOpenedMessage.const_1733];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_927:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_894:
