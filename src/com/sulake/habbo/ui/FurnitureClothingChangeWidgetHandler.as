package com.sulake.habbo.ui
{
   ...
   public class FurnitureClothingChangeWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver
   {
      ...
      private static const const_1356:String = "hr-165-45.hd-208-2.ch-250-64.lg-285-82.sh-290-64";
      
      private static const const_1355:String = "hr-681-41.hd-620-9.ch-879-90.lg-700-85.sh-735-68";
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_796,RoomWidgetClothingChangeMessage.const_409,RoomWidgetAvatarEditorMessage.const_407];
      }
            ...
            case RoomWidgetClothingChangeMessage.const_409:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     _loc9_ = "null";
                     _loc10_ = _loc4_.getString(RoomObjectVariableEnum.const_1088);
                     if(_loc10_ == null)
                     {
                        _loc10_ = const_1356;
                     }
                     ...
                     {
                        _loc9_ = "null";
                        _loc10_ = _loc4_.getString(RoomObjectVariableEnum.const_1198);
                        if(_loc10_ == null)
                        {
                           _loc10_ = const_1355;
                        }
                     }
                     if(this._container.avatarEditor.openEditor(_loc7_.window,this,[AvatarEditorFigureCategory.const_270,AvatarEditorFigureCategory.const_856],true))
                     {
                        _loc11_ = 0;
