package com.sulake.habbo.ui
{
   ...
   public class RoomQueueWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomQueueMessage.const_838:
            ...
            case RoomWidgetRoomQueueMessage.const_863:
               this._container.roomSession.changeQueue(RoomSessionQueueEvent.const_1049);
               break;
            case RoomWidgetRoomQueueMessage.const_661:
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionQueueEvent.const_505:
               ...
               {
                  case RoomSessionQueueEvent.const_1049:
                     _loc3_ = "null";
                     break;
               ...
               if(_loc5_.length > 1)
               {
                  ...
                  {
                     _loc6_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_1716) + 1;
                  }
               }
               else
               {
