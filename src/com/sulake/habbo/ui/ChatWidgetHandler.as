package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_845:Point = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_460 != null)
         {
            ...
            {
               _loc2_ = this.var_460.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_732,RoomWidgetChatSelectAvatarMessage.const_751];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_732:
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_751:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           {
                              _loc13_ = this.var_460.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_680.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                    ...
                                    default:
                                       ...
                                       if(_loc17_ != null)
                                       {
                                          ...
                                          if(_loc18_ != null)
                                          {
                                             ...
                                             this.var_680.add(_loc16_,_loc12_);
                                          }
                                       }
                                 }
                                 if(_loc13_ != null)
                                 {
                                    ...
                                    {
                                       this.var_460.add(_loc16_,_loc13_);
                                    }
                                 }
                              }
                           }
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_845 == null)
            {
               ...
               this.var_554.y = 0;
               this.var_554.z = 0;
               this.var_845 = _loc4_.getScreenPoint(this.var_554);
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_845.x || _loc8_.y != this.var_845.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_845,_loc5_));
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         if(this.var_460)
         {
            _loc2_ = this.var_460.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1284.push(_loc2_);
            }
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(_loc7_ != 0)
                  {
                     this.var_680.add(param1,_loc7_);
                  }
               }
            }
         }
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_2033.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_2033.remove(param1);
         if(_loc3_ != null)
         {
