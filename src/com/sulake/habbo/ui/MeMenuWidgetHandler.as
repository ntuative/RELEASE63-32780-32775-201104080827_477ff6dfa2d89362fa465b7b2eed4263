package com.sulake.habbo.ui
{
   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            if(this._inventory && !this._inventory.disposed && this._inventory.events)
            {
               ...
               this._inventory.events.removeEventListener(HabboInventoryHabboClubEvent.const_841,this.onHabboClubSubscriptionChanged);
            }
            if(this.var_160 && !this.var_160.disposed && this.var_160.events)
            {
               this.var_160.events.removeEventListener(HabboToolbarEvent.const_65,this.onHabboToolbarEvent);
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_544,this.onHelpTutorialEvent);
         ...
         if(this._inventory != null)
         {
            ...
            this._inventory.events.addEventListener(HabboInventoryHabboClubEvent.const_841,this.onHabboClubSubscriptionChanged);
         }
         this.var_160 = this._container.toolbar;
         ...
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_544,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc2_ != this.var_1481)
            {
               ...
               this.var_1481 = _loc2_;
               this.var_1857 = _loc1_;
            }
            else
            {
               _loc1_ = this.var_1857;
            }
         }
         if(this.var_160 != null)
         {
            _loc5_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1042,HabboToolbarIconEnum.MEMENU);
            if(_loc1_ != null)
            {
               _loc5_.bitmapData = _loc1_;
            }
            this.var_160.events.dispatchEvent(_loc5_);
         }
      }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetDanceMessage.const_913);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_747);
         ...
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_361);
         _loc1_.push(RoomWidgetStopEffectMessage.const_932);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1687);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1235);
         _loc1_.push(RoomWidgetToolbarMessage.const_884);
         _loc1_.push(RoomWidgetToolbarMessage.const_654);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_407);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1654);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1216);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_806);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_839);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_877);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1640);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_865);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_765);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_940);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetWaveMessage.const_857:
               ...
               break;
            case RoomWidgetDanceMessage.const_913:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_747:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_791:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_361:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1212)
               {
            ...
            case RoomWidgetOpenInventoryMessage.const_812:
               ...
               if(this._inventory != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1254:
                        this._catalog.openCatalogPage(CatalogPageName.const_1616,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1062:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_308);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1543:
            ...
            case RoomWidgetStopEffectMessage.const_932:
            ...
            case RoomWidgetNavigateToRoomMessage.const_1235:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_806:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_884:
               ...
               if(this.var_160)
               {
                  this.var_160.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_59,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(this._inventory != null)
                  {
                     _loc12_ = false;
            ...
            case RoomWidgetToolbarMessage.const_654:
               ...
               {
                  this.var_160.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_594,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_407:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_877:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_417,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_865:
               this._container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_417,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_765:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_417,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_940:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
            ...
            case RoomWidgetClothingChangeMessage.const_409:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_717));
               break;
            default:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_923));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_544:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_605));
         }
      }
