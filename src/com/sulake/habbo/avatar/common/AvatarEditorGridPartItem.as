package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem implements IAvatarImageListener
   {
      ...
      private var var_799:IFigurePartSet;
      ...
      private const const_2061:int = 13421772;
      
      private const const_2062:int = 16777215;
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         if(param3 != null)
         {
            ...
            {
               this.var_1894 = Math.max(this.var_1894,_loc6_.colorLayerIndex);
            }
         }
      ...
      private function updateThumbVisualization() : void
      {
         ...
         if(_loc1_)
         {
            if(this.var_698 != null && !this.var_1895)
            {
               _loc3_ = this.var_698;
            }
            else
            ...
            if(this.var_799)
            {
               switch(this.var_799.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_47:
                     _loc2_.style = HabboIconType.const_945;
               }
            }
            else
            {
      ...
      private function analyzePartLayers() : Boolean
      {
         ...
         for each(_loc2_ in this.partSet.parts)
         {
            if(_loc7_)
            {
               _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + this.const_352[_loc6_] + "_" + FigureData.const_149;
      ...
      private function renderThumb() : BitmapData
      {
         ...
         if(this.var_649 == null)
         {
            if(!this.analyzePartLayers())
            {
               if(!this.var_1896)
               {
                  ...
                  this.var_1896 = _loc9_.content as BitmapData;
               }
         ...
         for each(_loc2_ in _loc8_)
         {
            ...
            if(_loc4_)
            {
               ...
               if(this.var_1895 && _loc2_.colorLayerIndex > 0)
               {
