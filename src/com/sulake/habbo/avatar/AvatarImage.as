package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1329:String = "Default";
      
      private static const const_1327:int = 2;
      
      private static const const_1328:String = AvatarSetType.const_37;
      ...
      protected var var_687:AvatarFigureContainer;
      ...
      private var var_2686:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1328,const_1327);
         this.var_330 = new Array();
         this.var_946 = new ActiveActionData(AvatarAction.const_378);
         this.var_946.definition = this._structure.getActionDefinition(const_1329);
         this.resetActions();
      ...
      {
         return this._structure.getPartColor(this.var_687,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         param2 += this.var_1750;
         if(param2 < AvatarDirectionAngle.const_1089)
         {
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_268.length == 1 && this.var_87 == this.var_1802)
         {
            return this.var_87 + this.var_534 + this.var_657 % 4;
         }
      ...
      {
         if(param3 != this.var_2687 || param2 != this.var_2686 || param1 != this.var_2685)
         {
            this.var_2687 = param3;
            this.var_2686 = param2;
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1322 || this.var_46 == null || (this.var_46.width != _loc5_.width || this.var_46.height != _loc5_.height))
         {
            if(this.var_46 != null && !this.var_1322)
            {
               this.var_46.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_286.definition.geometryType,this.var_87);
         this.var_46.lock();
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_286.definition.geometryType,this.var_87);
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_330.push(new ActiveActionData(param1,param2,this.var_657));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_286 = this.var_946;
         this.var_286.definition = this.var_946.definition;
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_534 = "";
         this.var_268 = this._structure.sortActions(this.var_330);
         if(this.var_268 == null)
         {
         ...
         {
            this.var_821 = this._structure.getCanvasOffsets(this.var_268,this._scale,this.var_87);
            for each(_loc4_ in this.var_268)
            {
               this.var_534 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_332)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1513 != _loc5_)
                  {
                     _loc2_ = true;
                  }
            ...
            if(this.var_1512 != this.var_534)
            {
               _loc1_ = true;
               this.var_1512 = this.var_534;
            }
         }
         this.var_1420 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_268)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_941 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
               ...
               if(_loc1_.actionType == AvatarAction.const_326 || _loc1_.actionType == AvatarAction.WAVE || _loc1_.actionType == AvatarAction.const_398)
               {
                  this.var_941 = true;
               }
            }
