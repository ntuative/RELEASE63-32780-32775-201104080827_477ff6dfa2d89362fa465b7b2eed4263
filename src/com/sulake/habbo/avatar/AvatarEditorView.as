package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1304:IWindowContainer;
      
      public static var var_1581:IWindowContainer;
      
      public static var var_2063:int = 6710886;
      ...
      private var var_520:IFrameWindow;
      
      private var var_430:Timer;
      
      private var var_2500:Number = 0;
      
      private var var_2553:Boolean = true;
      
      private var var_1821:String;
      
      private var var_2554:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1205 = [];
         this.var_1466 = [AvatarEditorFigureCategory.const_746,AvatarEditorFigureCategory.const_51,AvatarEditorFigureCategory.const_270,AvatarEditorFigureCategory.const_856,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_106];
         super();
         ...
         if(var_1304 == null)
         {
            ...
            var_1304 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1581 == null)
         {
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1466);
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2553 = this.canChangeOutfit();
            this.var_430.stop();
            if(this._window)
            {
      ...
      private function attachImages() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc1_:Array = this.var_1466;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_44) && (this.var_1821 == AvatarEditorSideCategory.const_106 || this.var_2554))
         {
      ...
      {
         if(this.var_1821 == AvatarEditorSideCategory.const_106)
         {
            this.var_2554 = false;
            this.setSideContent(AvatarEditorSideCategory.const_656);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_656:
               break;
            case AvatarEditorSideCategory.const_548:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_548);
               break;
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "save":
                  ...
                  this.var_2500 = new Date().valueOf();
                  this.var_2553 = false;
                  this.var_430.start();
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_520)
         {
            ...
            this.var_520 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_520.procedure = this.stripClubDialogEventProc;
            this.var_520.center();
         }
         else
         {
      ...
      private function canChangeOutfit() : Boolean
      {
         ...
         return _loc1_ - this.var_2500 > 5000;
      }
   }
}
