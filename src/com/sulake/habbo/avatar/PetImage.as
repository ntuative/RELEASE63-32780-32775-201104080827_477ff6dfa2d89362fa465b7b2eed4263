package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_687:AvatarFigureContainer;
      ...
      public function PetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String)
      {
         ...
         this.var_687 = new AvatarFigureContainer(param3);
         var _loc5_:int = this.var_687.getPartSetId("pbd");
         this.solvePetAvatarTypeAndBreed(_loc5_);
         this.var_1419 = this.var_1078;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_51)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1419);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc15_ = this._structure.getParts(_loc8_,this.var_687,_loc13_,"pet",_loc12_.getDirection(),[]);
               _loc16_ = this.var_1419 < 3;
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            if(_loc10_ != null)
            {
               ...
               _loc16_ = this._structure.getParts(_loc9_,this.var_687,_loc14_,"pet",_loc13_.getDirection(),[]);
               _loc17_ = 32;
               if(this._scale == AvatarScaleType.const_87)
               {
                  _loc17_ = 6;
         ...
         switch(param1)
         {
            case AvatarAction.const_411:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1625:
                  case AvatarAction.const_1642:
                  case AvatarAction.const_1461:
                  case AvatarAction.const_1056:
                  case AvatarAction.const_1147:
                  case AvatarAction.const_1463:
                  case AvatarAction.const_1574:
      ...
      private function sortActions() : void
      {
         ...
         this.var_1421 = this._structure.sortActions(this.var_330);
         ...
         {
            this.var_821 = this._structure.getCanvasOffsets(this.var_1421,this._scale,this.var_87);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_1421)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_398)
               {
                  this.var_941 = true;
               }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1078 = _loc4_.id;
                     this.var_1603 = _loc4_.breed;
                     break;
                  }
               }
            }
