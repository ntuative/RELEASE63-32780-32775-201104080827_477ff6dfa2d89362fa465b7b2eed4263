package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1652:Number = 1.0;
      ...
      {
         super();
         this.var_1592 = parseInt(param1.@ink);
         ...
         this.var_2124 = parseInt(_loc3_,16);
         ...
         this.var_806 = new ColorTransform(this.var_1654,this.var_1653,this.var_1652,this._alphaMultiplier);
         this.var_1075 = this.generatePaletteMapForGrayscale(this.var_2124,this.var_2122);
      }
      ...
      {
         return this.var_1075.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1075.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1075.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1075.getValue("alphas") as Array;
      }
