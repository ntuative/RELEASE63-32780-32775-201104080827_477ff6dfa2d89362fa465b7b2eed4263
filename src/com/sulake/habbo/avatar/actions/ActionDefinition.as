package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_2770 = parseInt(param1.@precedence);
         this.var_2774 = String(param1.@activepartset);
         this.var_2771 = String(param1.@assetpartdefinition);
         this.var_2775 = String(param1.@lay);
         this.var_815 = String(param1.@geometrytype);
         this.var_2543 = Boolean(parseInt(param1.@main));
         this.var_2769 = Boolean(parseInt(param1.@method_1));
         this.var_2772 = Boolean(parseInt(param1.@animation));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "default")
            {
               this.var_2773 = _loc6_;
            }
            else
            {
               this.var_1936[_loc5_] = _loc6_;
            }
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1936[param1];
         if(_loc2_ == null)
         {
