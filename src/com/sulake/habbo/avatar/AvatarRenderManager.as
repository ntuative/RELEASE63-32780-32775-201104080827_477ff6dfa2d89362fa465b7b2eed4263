package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2065:String = "hd-99999-99999";
      ...
      private var var_789:PaletteManager;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_594 = RenderMode.const_1614;
         ...
         this.var_103.add(AvatarType.const_116,_loc4_);
         ...
         this.var_103.add(AvatarType.const_68,_loc4_);
         ...
         this.var_789 = new PaletteManager(param1.assets as AssetLibraryCollection);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_313.init();
         this.var_789.init();
         _loc2_ = this.var_103.getValue(AvatarType.const_116) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_103.getValue(AvatarType.const_68) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_103.getValue(AvatarType.const_116) as AvatarStructure;
            if(_loc3_ != null)
            {
      ...
      private function checkIfReady() : void
      {
         if(!this.var_1023)
         {
            if(this.var_2603 && this.var_2601 && this.var_2602)
            {
      ...
      {
         var _loc5_:AvatarStructure = this.var_103.getValue(AvatarType.const_116) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_1868)
         {
            this.var_1868 = new AvatarFigureContainer(this.const_2065);
         }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1580)
         {
            _loc6_ = !this.var_313.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_313.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_103.getValue(AvatarType.const_68) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
      ...
      public function resetPetData() : void
      {
         ...
         var _loc2_:AvatarStructure = this.var_103.getValue(AvatarType.const_68);
      ...
      {
         var _loc3_:AvatarStructure = this.var_103.getValue(AvatarType.const_116) as AvatarStructure;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_68:
               _loc3_ = this.var_103.getValue(AvatarType.const_68) as AvatarStructure;
               break;
            default:
