package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1332:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1331:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_1162:AvatarEditorHandler;
      ...
      private var var_952:IFigureData;
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_193)
         {
            ...
            this.var_611["null"] = new FigureData(this);
            this.var_611["null"] = new FigureData(this);
            _loc2_ = this.var_611["null"];
            _loc3_ = this.var_611["null"];
            _loc2_.loadAvatarData(const_1332,FigureData.const_81);
            _loc3_.loadAvatarData(const_1331,FigureData.FEMALE);
            this.var_99 = new Map();
            this.var_511 = new Map();
            this.var_99.add(AvatarEditorFigureCategory.const_746,new BodyModel(this));
            this.var_99.add(AvatarEditorFigureCategory.const_51,new HeadModel(this));
            this.var_99.add(AvatarEditorFigureCategory.const_270,new TorsoModel(this));
            this.var_99.add(AvatarEditorFigureCategory.const_856,new LegsModel(this));
            ...
            this.var_511.add(AvatarEditorSideCategory.const_106,new WardrobeModel(this));
            this.var_511.add(AvatarEditorSideCategory.const_548,new ClubPromoModel(this));
            this.var_193 = true;
         }
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var _loc4_:FigureData = this.var_611[param2];
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_952.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_952.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this.var_256 == null)
            {
               this.var_256 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_73,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_256.addChild(this._view.window);
               if(param5)
               {
                  this.var_256.center();
               }
            ...
            this.var_256.visible = !this.var_256.visible;
         }
         this._view.show();
      ...
      {
         this.var_952 = this.var_510.getFigureData(AvatarType.const_116);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1162 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_611[this.var_1055];
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1763;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1163 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1330)
                  {
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1304.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1682)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_1163 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1304.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_1163 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_511.getValue(AvatarEditorSideCategory.const_106);
      }
