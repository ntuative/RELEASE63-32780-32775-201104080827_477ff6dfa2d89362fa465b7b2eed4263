package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2704:PseudoRandom;
      ...
      private const const_1794:String = "fuselogin";
      ...
      {
         if(this.var_56 && this.var_165 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_234 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         ...
         {
            this.var_234.loadHotelViewImage(_loc2_ + _loc1_);
         }
         var _loc3_:* = this.var_165.getKey("use.sso.ticket") == "1";
         this.var_660 = this.var_165.getKey("sso.ticket",null);
         this.var_1937 = this.var_165.getKey("flash.client.url","");
         this.var_2706 = this.var_165.getKey("external.variables.txt","");
         if(this.var_234 == null)
         {
            this.var_234 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_522,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_56.mode = HabboConnectionType.const_1186;
            }
         }
         this.var_56.initConnection(HabboConnectionType.const_241);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_930);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2704 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_56.mode)
         {
            case HabboConnectionType.const_91:
               ...
               this.var_1516 = _loc4_;
               this.var_234.loadBannerImage(_loc7_ + "?token=" + this.var_1516,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1186:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1584:
               this.var_1011 = this.generateRandomHexString(30);
               this.var_538 = new DiffieHellman(new BigInteger(this.var_165.getKey("connection.development.prime"),16),new BigInteger(this.var_165.getKey("connection.development.generator"),16));
               this.var_538.init(this.var_1011);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2704);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1937,this.var_2706));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1794,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_660 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_660);
            _loc2_.send(_loc4_);
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2705)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1516);
