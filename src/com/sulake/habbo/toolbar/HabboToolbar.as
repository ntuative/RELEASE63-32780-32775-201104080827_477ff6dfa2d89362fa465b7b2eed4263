package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_1498:LogoutController;
      ...
      {
         this._view = new ToolbarView(this._windowManager,this._assetLibrary,this.var_293.getHabboMainConnection(null),events,this._config);
         if(this._config && this._config.getKey("client.logout.enabled","false") == "true")
         {
            this.var_1498 = new LogoutController(this._windowManager,this._assetLibrary,events);
         }
         if(this._view == null)
         {
            return;
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_594,this.onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1045,this.onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1222,this.onHideWindowEvent);
         this._state = true;
