package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      private var var_2907:Number;
      
      private var var_2908:Number;
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         this.var_2907 = param4;
         this.var_2908 = param5;
         this._frame = 0;
         this.var_955 = 0;
         ...
         if(_loc9_.length() > 0)
         {
            ...
            while(_loc10_ < _loc9_.length())
            {
               ...
               if(_loc8_ != null)
               {
                  this.var_957.push(_loc11_);
                  this.var_956.push(_loc8_);
               }
               _loc10_++;
            }
         }
         else
         {
            ...
            if(_loc8_ != null)
            {
               this.var_957.push(new XML());
               this.var_956.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            this.var_956[this._frame] = param6.clone();
         }
      ...
      {
         if(this.var_1443 == true || this.var_955 == 0)
         {
            if(this.var_957.length > 0)
            {
               ++this._frame;
               if(this._frame >= this.var_957.length)
               {
                  this._frame = 0;
                  ++this.var_955;
               }
      ...
      {
         return this.var_957.length;
      }
      
      public function hasNextState() : Boolean
      {
         return this.var_1443 == false && this.var_955 == 1 && this.var_1651 != this._state;
      }
      ...
      {
         var _loc2_:* = null;
         if(this._frame <= this.var_956.length)
         {
            _loc2_ = this.var_956[this._frame];
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         {
            _loc3_ = new BitmapData(Math.max(param2.width,this.var_761.width),Math.max(param2.height,this.var_761.height),true,0);
            _loc4_ = _loc3_.height - this.var_761.rect.height;
            _loc3_.copyPixels(this.var_761,this.var_761.rect,new Point(0,_loc4_),null,null,true);
