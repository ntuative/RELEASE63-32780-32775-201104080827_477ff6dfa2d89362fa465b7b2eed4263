package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_525:String = "LEFT";
      
      private var var_161:Number = 50;
      
      private var var_1225:Boolean = true;
      
      private var var_1224:Number = 1;
      
      private var var_1486:Number = 0;
      
      private var var_1867:Number = 15;
      
      private var var_1866:Number = 5;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IConnection, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_231 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_73,HabboWindowStyle.const_1146,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1225 = String(_loc8_.relocate_by_drag.@state) == "true";
         if(this.var_1225)
         {
         ...
         this.var_1224 = _loc8_.toolbar.@margin_top;
         this.var_1486 = _loc8_.toolbar.@margin_bottom;
         this.var_1867 = _loc8_.toolbar.@min_group_margin;
         this.var_1866 = _loc8_.toolbar.@margin_to_extrabar;
         this.var_300 = new ToolbarBarMenuAnimator(param1,this);
         var _loc9_:XMLList = XMLList(_loc8_.toolbar).children();
         var _loc10_:XMLList = XMLList(_loc8_.extras).children();
         this.createGroupsFromXmlList(_loc9_,this.var_262,param1,param2,param3,this._window,this.var_300);
         this.createGroupsFromXmlList(_loc10_,this.var_635,param1,param2,param3,this.var_231,this.var_300);
         this.alignWindows();
      }
      ...
      private function createGroupsFromXmlList(param1:XMLList, param2:Array, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IConnection, param6:IWindowContainer, param7:ToolbarBarMenuAnimator) : void
      {
         ...
         while(_loc11_ < param1.length())
         {
            ...
            _loc10_ = new ToolbarIconGroup(param3,param4,param5,_loc11_,this._events,param6,param7,this.var_161,this._config);
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_161,this.var_525,param3);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,this.var_525);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_161,this.var_525);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_161,this.var_525);
         }
      }
      ...
      {
         this.alignWindows();
         var _loc2_:HabboToolbarEvent = new HabboToolbarEvent(HabboToolbarEvent.const_827);
      ...
      private function alignWindows() : void
      {
         ...
         if(this._window == null || this.var_231 == null)
         {
            return;
         }
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_231.x = this.var_161 + this.var_1866;
               this.var_231.y = 0;
            ...
            case "TOP":
               ...
               this._window.y = 0;
               this.var_231.x = 0;
               this.var_231.y = this.var_161 + this.var_1866;
         ...
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_1224;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_262.length > 1)
            {
               ...
               {
                  _loc6_ = Number(Math.max(this.var_1867,(this._window.height - _loc5_ * _loc8_ - this.var_1224 - this.var_1486) / (this.var_262.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_1867,(this._window.width - _loc5_ * _loc8_ - this.var_1224 - this.var_1486) / (this.var_262.length - 1)));
               }
            }
         }
         _loc2_ = 0;
         while(_loc2_ < this.var_262.length)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.orientation = this.var_525;
      ...
      private function onStageMouseMove(param1:MouseEvent) : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_1225 && this.var_1485)
         {
            _loc2_ = this.getTargetOrientationFromXY(param1.stageX,param1.stageY);
            if(_loc2_ != null && _loc2_ != this.var_525)
            {
               this.var_525 = _loc2_;
               this.alignWindows();
               if(this._events != null)
               {
                  _loc3_ = new HabboToolbarEvent(HabboToolbarEvent.const_529);
                  _loc3_.orientation = this.var_525;
