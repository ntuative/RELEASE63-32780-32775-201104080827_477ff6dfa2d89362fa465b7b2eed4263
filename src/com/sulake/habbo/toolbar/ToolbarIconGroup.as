package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      public function get size() : Number
      {
         ...
         {
            if(this.var_294[_loc2_].exists)
            {
               _loc1_ += this.var_1353;
            }
            _loc2_++;
         }
         return _loc1_;
      ...
      private function alignItems() : void
      {
         ...
         {
            _loc2_ = this.var_720.indexOf(this.var_1355[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = this.var_294[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(this.var_1268 + _loc3_);
                  _loc3_ += this.var_1353;
               }
            }
            _loc4_++;
         }
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return this.var_294[this.var_720.indexOf(param1)];
      }
