package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIcon
   {
      ...
      private var var_1153:ToolbarIconBouncer;
      ...
      public function ToolbarIcon(param1:ToolbarIconGroup, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:String, param6:IEventDispatcher, param7:ToolbarBarMenuAnimator)
      {
         ...
         this.var_1153 = new ToolbarIconBouncer(0.8,1);
         super();
         this.var_509 = param1;
         ...
         this._events = param6;
         this.var_300 = param7;
         this.var_1427 = new Timer(40,40);
         this.var_1427.addEventListener(TimerEvent.TIMER,this.updateBouncer);
      ...
      public function set exists(param1:Boolean) : void
      {
         ...
         if(this._region != null)
         {
            this._region.visible = this.var_1155;
         }
      }
      ...
      public function defineFromXML(param1:XML) : void
      {
         ...
         this.var_1157 = param1.@id;
         this.var_2446 = int(param1.@window_offset_from_icon);
         this.var_2252 = int(param1.@window_margin);
         this.var_2903 = param1.@label;
         ...
         if(_loc2_.length() > 0)
         {
            ...
            while(_loc3_ < _loc2_.length())
            {
               ...
               this.var_1156.push(_loc5_.id);
               this.var_1756.push(_loc5_);
               if(_loc3_ == 0)
               {
                  if(this.var_1426 == "-1")
                  {
                     this.var_1426 = _loc5_.id;
                  }
                  if(this.var_1152 == "-1")
                  {
      ...
      public function menuLockedToIcon(param1:String) : Boolean
      {
         ...
         var _loc2_:MenuSettingsItem = this.var_1154[this.var_757.indexOf(param1)];
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Number, param4:String, param5:Point) : void
      {
         ...
         {
            this.var_300.animateWindowIn(this,param1,param2,this.var_756,param3,param4,this.getMenuYieldList(param1));
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer, param3:Number, param4:String) : void
      {
         if(this.var_300 != null)
         {
            this.var_300.positionWindow(this,param1,param2,this.var_756,param3,this.getMenuYieldList(param1));
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer, param3:Number, param4:String) : void
      {
         if(this.var_300 != null)
         {
            this.var_300.hideWindow(param1,param2,this.var_756,param3);
         }
      }
      ...
      {
         return this.var_1756[this.var_1156.indexOf(param1)];
      }
      ...
      private function setTooltip() : void
      {
         ...
         {
            this._region.toolTipCaption = "${toolbar.icon.tooltip." + this.var_1157.toLowerCase() + "}";
         }
      ...
      private function setLabel() : void
      {
         ...
         {
            this.var_356.caption = "${toolbar.icon.label." + this.var_1157.toLowerCase() + "}";
         }
         this.updateRegion();
      }
      ...
      {
         return this.var_2252 + this.var_509.windowMargin;
      }
      ...
      {
         if(this.var_1153 != null && this._icon != null)
         {
            this.var_1153.update();
            this._icon.y = this.var_1153.location;
         }
      }
      ...
      private function onMouseEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               if(this.var_300)
               {
                  this.var_300.repositionWindow(this.var_756,true);
               }
               if(this._events != null)
               {
                  _loc4_ = new HabboToolbarEvent(HabboToolbarEvent.const_36);
                  _loc4_.iconId = this.var_756;
                  _loc4_.iconName = this.var_1157;
                  _loc5_ = new ConversionPointMessageComposer("Toolbar",this.var_1157,"client.toolbar.clicked");
                  if(this._connection)
                  {
      ...
      private function updateRegion() : void
      {
         ...
         if(_loc1_)
         {
            ...
            this.var_147 = this.var_1268 + (this.var_509.iconSize - this._region.height) / 2;
         }
         else
         {
            this._x = this.var_1268 + (this.var_509.iconSize - this._region.width) / 2;
