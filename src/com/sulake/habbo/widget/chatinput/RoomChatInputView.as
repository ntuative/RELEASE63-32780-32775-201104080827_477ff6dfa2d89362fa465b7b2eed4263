package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1312:int = 11;
      
      private static const const_623:int = 18;
      
      private static const const_967:int = 16;
      
      private static const const_1313:int = 20;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         this.var_2386 = this._localization.getKey("widgets.chatinput.mode.speak",":speak");
      ...
      private function createWindow() : void
      {
         ...
         this._window.addEventListener(WindowEvent.const_253,this.onWindowMoved);
         this.var_1713 = true;
         this.var_499 = "";
         this.refreshView();
      }
      ...
      private function refreshView() : void
      {
         ...
         this._window.width = _loc1_.width + const_623 + const_967;
         _loc1_.x = const_623;
         _loc1_.y = const_1312;
      }
      ...
      {
         this.var_303 = param1 - (const_623 + const_967);
      ...
      private function onWindowMoved(param1:WindowEvent) : void
      {
         ...
         this.setMaxWidth(this._window.context.getDesktopWindow().width - this._window.x - const_1313);
      }
