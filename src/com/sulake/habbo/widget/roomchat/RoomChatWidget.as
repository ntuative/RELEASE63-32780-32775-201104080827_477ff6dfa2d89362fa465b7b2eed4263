package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_1322:int = 9;
      
      private static const const_969:int = 10;
      
      private static const const_625:int = 25;
      
      private static const const_1326:int = 25;
      ...
      private static const const_624:int = 8;
      
      private static const const_433:int = 0;
      
      private static const const_971:int = (const_624 + const_433) * const_111 + const_111;
      
      private static const const_434:int = 9;
      ...
      private var var_2425:int = 150;
      
      private var var_226:int = 171.0;
      
      private var var_944:int = 18;
      ...
      public function RoomChatWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:int, param6:Component)
      {
         ...
         this.var_39 = param1.createWindow("chat_container","",HabboWindowType.const_73,HabboWindowStyle.const_30,HabboWindowParam.const_43,new Rectangle(0,0,200,this.var_226 + RoomChatHistoryPulldown.const_83),null,0) as IWindowContainer;
         this.var_39.background = true;
         this.var_39.color = 33554431;
         this.var_39.tags.push("room_widget_chat");
         this.var_355 = param1.createWindow("chat_contentlist","",HabboWindowType.const_1130,HabboWindowStyle.const_43,0 | 0,new Rectangle(0,0,200,this.var_226),null,0) as IItemListWindow;
         this.var_39.addChild(this.var_355);
         this._activeContentWindow = param1.createWindow("chat_active_content","",HabboWindowType.const_73,HabboWindowStyle.const_43,HabboWindowParam.const_62,new Rectangle(0,0,200,this.var_226),null,0) as IWindowContainer;
         this._activeContentWindow.clipping = false;
         this.var_355.addListItem(this._activeContentWindow);
         this.var_27 = new RoomChatHistoryViewer(this,param1,this.var_39,param2);
         this.var_2423 = param4.getKey("site.url");
         this.var_2425 = int(param4.getKey("chat.history.item.max.count","150"));
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_941)
         {
            _loc2_ = param1 / const_1326 * const_1323;
            if(_loc2_ + this.var_943 > this.var_944)
            {
               _loc2_ = this.var_944 - this.var_943;
            }
            if(_loc2_ > 0)
            {
            ...
            if(this.var_943 >= this.var_944)
            {
               this.var_944 = const_111;
               this.var_943 = 0;
               this.animationStop();
               this.processBuffer();
               this.var_1149 = getTimer() + const_970;
            }
         }
         if(this.var_27 != null)
         {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChatUpdateEvent.const_735,this.onChatMessage);
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_346,this.onRoomViewUpdate);
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_653,this.onRoomViewUpdate);
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_909,this.onRoomViewUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChatUpdateEvent.const_735,this.onChatMessage);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_346,this.onRoomViewUpdate);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_653,this.onRoomViewUpdate);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_909,this.onRoomViewUpdate);
      }
      
      private function onChatMessage(param1:RoomWidgetChatUpdateEvent) : void
      {
         var _loc2_:RoomChatItem = new RoomChatItem(this,windowManager,assets,this.getFreeItemId(),localizations,this.var_2423);
      ...
      private function onRoomViewUpdate(param1:RoomWidgetRoomViewUpdateEvent) : void
      {
         ...
         if(param1.scale > 0)
         {
            if(this.var_1748 == 0)
            {
               this.var_1748 = param1.scale;
            }
            else
            {
               this.var_942 = param1.scale / this.var_1748;
            }
         }
         if(param1.positionDelta != null)
         {
            this.var_753.x += param1.positionDelta.x / this.var_942;
            this.var_753.y += param1.positionDelta.y / this.var_942;
         }
         if(param1.rect != null)
         {
            if(this.var_27 == null)
            ...
            this.var_39.height = this.var_226 + this.var_27.method_4;
            this.var_355.width = this.var_39.width - this.var_27.scrollbarWidth;
            this.var_355.height = this.var_226;
            this.var_355.x = this.var_39.x;
            this.var_355.y = this.var_39.y;
      ...
      private function processBuffer() : void
      {
         ...
         while(this.var_69.length > const_1324 || this.historyViewerActive() && this.var_69.length > 0)
         {
         ...
         else
         {
            ...
            {
               this.var_944 = this.getItemSpacing(this._itemList[this._itemList.length - 1],this.var_69[0]);
            }
            else
            {
               this.var_944 = const_111;
      ...
      private function activateItemFromBuffer() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc1_.aboveLevels > const_624 + const_433 + 2)
               {
                  _loc1_.aboveLevels = const_624 + const_433 + 2;
               }
               this.var_754 = 0;
      ...
      private function selectItemsToMove() : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            if(_loc4_.view != null)
            {
               if(_loc4_.screenLevel > const_433 || _loc4_.screenLevel == _loc2_ - 1 || _loc1_ - _loc4_.timeStamp >= const_1325)
               {
      ...
      private function setChatItemLocHorizontal(param1:RoomChatItem) : void
      {
         ...
         var _loc2_:Number = (param1.senderX + this.var_753.x) * this.var_942;
         var _loc3_:Number = _loc2_ - param1.width / 2;
         var _loc4_:Number = _loc3_ + param1.width;
         var _loc5_:Number = -this.var_39.width / 2 - const_969;
         var _loc6_:Number = this.var_39.width / 2 + const_969 - this.var_27.scrollbarWidth;
      ...
      private function setChatItemLocVertical(param1:RoomChatItem) : void
      {
         ...
         if(param1 != null)
         {
            ...
            {
               param1.y = this.getAreaBottom() - (_loc3_ + 1) * const_111 - const_434;
            }
            else
            {
      ...
      private function getAreaBottom() : Number
      {
         ...
         return this.var_226 + this.var_39.y;
      }
      ...
      private function purgeItems() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc3_:int = 0;
         while(this._itemList.length > this.var_2425)
         {
      ...
      {
         return "chat_" + this.var_2424.toString() + "_item_" + (this.var_2426++).toString();
      }
      ...
      public function onItemMouseClick(param1:int, param2:String, param3:int, param4:int, param5:int, param6:WindowMouseEvent) : void
      {
         ...
         var _loc7_:RoomWidgetRoomObjectMessage = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_427,param1,param3);
         messageListener.processWidgetMessage(_loc7_);
         var _loc8_:RoomWidgetChatSelectAvatarMessage = new RoomWidgetChatSelectAvatarMessage(RoomWidgetChatSelectAvatarMessage.const_751,param1,param2,param4,param5);
      ...
      public function stretchAreaBottomTo(param1:Number) : void
      {
         ...
         this.var_226 = param1 - this.var_39.y;
         this.var_39.height = this.var_226 + RoomChatHistoryPulldown.const_83;
         if(this.var_27 != null)
         {
            this.var_27.containerResized(this.var_39.rectangle);
         }
      ...
      public function resetArea() : void
      {
         ...
         this.animationStop();
         this.var_226 = const_971 + const_434;
         this.var_39.height = this.var_226 + this.var_27.method_4;
         this.var_355.width = this.var_39.width - this.var_27.scrollbarWidth;
         this.var_355.height = this.var_226;
         this._activeContentWindow.width = this.var_39.width - this.var_27.scrollbarWidth;
         if(this.historyViewerActive())
         {
            this._activeContentWindow.height = this.getTotalContentHeight() + const_434;
         }
         else
         {
            this._activeContentWindow.height = this.var_226;
      ...
      public function resizeContainerToLowestItem() : void
      {
         ...
         if(Math.abs(_loc3_) < RoomChatHistoryViewer.const_1201)
         {
            this.resetArea();
            return;
         }
      ...
      public function mouseUp() : void
      {
         ...
         if(_loc1_ < const_971)
         {
            if(_loc1_ <= this.var_226 + this.var_39.y)
            {
               if(this.historyViewerActive())
               {
                  this.hideHistoryViewer();
         ...
         if(this.var_1747 && !this.historyViewerActive())
         {
            this.resetArea();
            this.var_1747 = false;
         }
