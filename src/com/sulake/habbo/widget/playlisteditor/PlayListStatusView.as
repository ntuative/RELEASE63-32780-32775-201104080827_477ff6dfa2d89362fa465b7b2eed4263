package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_749:String = "PLSV_ADD_SONGS";
      
      public static const const_1196:String = "PLSV_START_PLAYBACK";
      
      public static const const_453:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_44 != const_453)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_417[this.var_44];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_417[const_749];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_417.add(const_453,_loc1_);
