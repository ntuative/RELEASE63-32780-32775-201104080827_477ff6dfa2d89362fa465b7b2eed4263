package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class PlayListEditorItem
   {
      ...
      public static const const_545:String = "PLEI_ICON_STATE_NORMAL";
      ...
      private var var_2430:IContainerButtonWindow = null;
      ...
      private function createWindow() : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               this.var_2430 = _loc3_.getChildByName("button_remove_from_playlist") as IContainerButtonWindow;
            }
         }
      }
