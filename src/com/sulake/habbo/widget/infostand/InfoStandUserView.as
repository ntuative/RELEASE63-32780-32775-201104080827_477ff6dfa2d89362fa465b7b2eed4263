package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      protected var var_98:IWindowContainer;
      
      private var var_53:IBorderWindow;
      
      private var var_1300:TagListRenderer;
      
      private var var_125:IBorderWindow;
      
      private var var_2111:int;
      
      private const const_949:int = 5;
      
      private const const_1755:int = 39;
      
      private const const_1756:int = 7829367;
      
      private const const_1757:int = 16777215;
      
      private const const_2024:int = 2000;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1300 = new TagListRenderer(param1,this.onTagSelected);
      }
      ...
      {
         if(this.var_52 == null || this.var_53 == null || this.var_98 == null)
         {
            return;
         }
         this.var_52.height = this.var_52.scrollableRegion.height;
         this.var_53.height = this.var_52.height + 20;
         this._window.width = Math.max(this.var_53.width,this.var_98.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_53.width < this.var_98.width)
         {
         ...
         {
            this.var_98.x = this._window.width - this.var_98.width;
            this.var_53.x = 0;
         }
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         this.var_98 = this._window.getListItemByName("button_list") as IWindowContainer;
         var _loc3_:* = [];
         this.var_98.groupChildrenWithTag("CMD_BUTTON",_loc3_,true);
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_949;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            if(param1 == "")
            {
               ...
               _loc3_.textColor = this.const_1756;
            }
            else
            {
               _loc3_.textColor = this.const_1757;
            }
            _loc3_.enable();
         }
         else
         ...
         _loc3_.text = param1;
         _loc3_.height = _loc3_.textHeight + this.const_949;
         if(param2)
         {
            _loc3_.addEventListener(WindowKeyboardEvent.const_366,this.onMottoKeyboard);
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc3_.removeEventListener(WindowKeyboardEvent.const_366,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1300.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      private function enableButton(param1:String, param2:Boolean = true) : void
      {
         ...
         var _loc3_:IRegionWindow = this.var_98.getChildByName(param1) as IRegionWindow;
      ...
      protected function showButton(param1:String, param2:Boolean) : void
      {
         ...
         var _loc3_:IWindow = this.var_98.getChildByName(param1);
         if(_loc3_ != null)
         {
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_1205:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2111 > this.const_2024 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2111 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1756;
            if(_loc3_.length >= this.const_1755)
            {
               _loc2_.text = _loc3_.substring(0,this.const_1755 - 1);
            }
         }
      }
      ...
      {
         var _loc5_:* = null;
         this.var_98.width = 250;
         var _loc2_:* = [];
         this.var_98.groupChildrenWithTag("CMD_BUTTON_REGION",_loc2_,true);
         var _loc3_:int = 250;
         var _loc4_:int = 0;
