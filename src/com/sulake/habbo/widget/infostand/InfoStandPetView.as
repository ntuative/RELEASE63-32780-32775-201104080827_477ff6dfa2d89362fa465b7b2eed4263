package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_2035:int = 152;
      
      private const const_2027:int = 16;
      
      private const const_1278:int = 4;
      
      private const const_2036:uint = 14342874;
      
      private const const_2029:uint = 3815994;
      
      private const const_2032:uint = 2085362;
      
      private const const_2033:uint = 39616;
      
      private const const_2030:uint = 10513106;
      
      private const const_2028:uint = 8734654;
      
      private const const_2031:uint = 9094430;
      
      private const const_2038:uint = 6200576;
      
      private const const_2034:String = "happiness";
      
      private const const_2037:String = "experience";
      
      private const const_2039:String = "energy";
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_2034,param1.nutrition,param1.nutritionMax,this.const_2033,this.const_2032);
         this.updateStateElement(this.const_2037,param1.experience,param1.experienceMax,this.const_2028,this.const_2030);
         this.updateStateElement(this.const_2039,param1.energy,param1.energyMax,this.const_2038,this.const_2031);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(this.const_2035,this.const_2027,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),this.const_2036);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,this.const_2029);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_197 && this.var_197.getPetId() == this.var_524)
               {
