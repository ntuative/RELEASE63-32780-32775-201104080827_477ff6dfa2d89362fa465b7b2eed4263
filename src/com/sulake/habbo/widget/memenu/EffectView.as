package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_2072:int = 1000;
      ...
      private var var_1033:IWindow;
      
      public function EffectView()
      {
         super();
         this.var_205 = new Timer(this.const_2072);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_189.isActive)
         {
            ...
            this.var_1032.width = _loc2_ * this.var_303;
         }
         else
         {
            this.var_1032.width = 0;
            this.var_205.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         var _loc1_:String = this.var_829.text;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            this.var_1033 = this._window.findChildByName("effect_hilite");
            this.var_1033.visible = false;
         }
         this.setTimeLeft();
         this.var_1032 = this._window.findChildByName("loader_bar");
         if(this.var_1032 != null)
         {
            this.var_303 = this.var_1032.width;
            this.var_205.start();
            this.onUpdate();
         }
