package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsSlider
   {
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc3_ != null && this.var_700 != null)
         {
            _loc3_.bitmap = new BitmapData(this.var_700.width,this.var_700.height,true,16777215);
            _loc3_.bitmap.copyPixels(this.var_700,this.var_700.rect,new Point(0,0),null,null,true);
         }
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null && this.var_701 != null)
               {
                  _loc3_.bitmap = new BitmapData(this.var_701.width,this.var_701.height,true,16777215);
                  _loc3_.bitmap.copyPixels(this.var_701,this.var_701.rect,new Point(0,0),null,null,true);
                  _loc2_.procedure = this.buttonProcedure;
                  this.var_1590 = _loc1_.width - _loc3_.width;
               }
            }
         }
      }
