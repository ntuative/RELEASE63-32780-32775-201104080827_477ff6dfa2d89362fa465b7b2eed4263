package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_73,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1294,WINDOW_INITIAL_Y,2,2),null,0) as IWindowContainer;
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1402 = _loc2_.light;
         if(this.var_420 != null)
         {
            this.var_420.setValue(this.var_1402);
         }
         this.var_540 = this.colors.indexOf(_loc2_.color);
         if(this.var_598 != null)
         {
            this.var_598.setSelectedColorIndex(this.var_540);
         }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1403 = XML(_loc1_.content);
         return this.var_1403;
      }
