package com.sulake.habbo.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_618:String = "welcome_gift_email_unverified";
      
      private const const_960:String = "welcome_gift_email_verified";
      
      private const const_1279:String = "welcome_gift_email_change";
      
      private const const_2040:int = 4;
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1101)
         {
            this.setViewState(this.const_960);
         }
         else
         {
            this.setViewState(this.const_618);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_618:
               ...
               this._view.findChildByName("edit_text").visible = this.var_895;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_31,this.var_895);
               break;
            case this.const_960:
            ...
            case this.const_1279:
               ...
               this.setBitmap("email_icon","email_icon");
               this.setButtonState("save_email",this.var_895);
      ...
      {
         this.setViewState(this.const_1279);
      }
      ...
      {
         this.setViewState(!!this.var_1101 ? this.const_960 : this.const_618);
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_826,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_826,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_491:
               ...
               this.var_1101 = param1.isVerified;
               this.var_895 = param1.allowEmailChange;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         ...
         {
            if(param1.result == this.const_2040)
            {
               this.var_895 = false;
            }
