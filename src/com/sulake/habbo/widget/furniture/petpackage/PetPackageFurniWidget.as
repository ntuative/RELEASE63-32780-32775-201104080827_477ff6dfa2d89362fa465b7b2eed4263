package com.sulake.habbo.widget.furniture.petpackage
{
   ...
   public class PetPackageFurniWidget extends RoomWidgetBase
   {
      ...
      {
         var _loc2_:* = null;
         if(this.var_682 == null || this._window == null)
         {
            return;
         }
         ...
         if(_loc1_ != null)
         {
            ...
            _loc2_ = new Point((_loc1_.width - this.var_682.width) / 2,(_loc1_.height - this.var_682.height) / 2);
            _loc1_.bitmap.copyPixels(this.var_682,this.var_682.rect,_loc2_);
         }
      }
      ...
      private function sendOpenPetPackage() : void
      {
         ...
         if(this.var_1294 || this.var_358 == -1)
         {
            return;
         }
         ...
         {
            this.var_1294 = true;
            message = new RoomWidgetOpenPetPackageMessage(RoomWidgetOpenPetPackageMessage.const_875,this.var_358,name);
