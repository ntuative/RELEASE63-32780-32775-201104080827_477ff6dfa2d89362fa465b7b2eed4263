   ...
   public class PetLogic extends MovingObjectLogic
   {
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(param1 is RoomObjectAvatarExperienceUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_849,Number(_loc9_.gainedExperience));
            return;
         }
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            ...
            _loc2_.setString(RoomObjectVariableEnum.const_1545,_loc10_.race);
            _loc2_.setNumber(RoomObjectVariableEnum.const_811,this.getPaletteIndex(_loc10_.figure));
            return;
         }
      }
      ...
      private function debugMouseEvent(param1:RoomSpriteMouseEvent) : void
      {
         ...
         if(!param1.altKey && !param1.ctrlKey)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_195,_loc3_ + this.var_1038);
         }
         else if(param1.altKey && !param1.ctrlKey)
         {
            ++this.var_2004;
            _loc2_.setNumber(RoomObjectVariableEnum.const_261,this.var_2004);
            _loc2_.setNumber(RoomObjectVariableEnum.const_135,NaN);
         }
         else if(param1.ctrlKey && !param1.altKey)
         {
            ++this.var_2003;
            _loc2_.setNumber(RoomObjectVariableEnum.const_135,this.var_2003);
         }
         else
         {
            this.var_1038 += 45;
