package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1476:uint = 16777215;
      
      private var var_1841:int = 255;
      
      private var var_1211:uint = 16777215;
      
      private var var_1842:int = 255;
      
      private var var_1212:int = 0;
      
      private var var_1840:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_532,RoomObjectMouseEvent.const_158];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1253,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_825,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_690,1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1212)
         {
            ...
            if(_loc2_ - this.var_1212 >= this.var_1840)
            {
               _loc3_ = this.var_1211;
               _loc4_ = this.var_1842;
               this.var_1212 = 0;
            }
            else
            {
               _loc7_ = this.var_1476 >> 16 & 255;
               _loc8_ = this.var_1476 >> 8 & 255;
               _loc9_ = this.var_1476 & 255;
               _loc10_ = this.var_1211 >> 16 & 255;
               _loc11_ = this.var_1211 >> 8 & 255;
               _loc12_ = this.var_1211 & 255;
               _loc13_ = (_loc2_ - this.var_1212) / this.var_1840;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1841 + (this.var_1842 - this.var_1841) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_825,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_840:
               ...
               break;
            case RoomObjectRoomUpdateMessage.const_657:
               param2.setString(RoomObjectVariableEnum.const_343,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_719:
               param2.setString(RoomObjectVariableEnum.const_290,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_552:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_273)
               {
                  _loc5_ = "null";
               }
               this.var_481.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_730:
               _loc4_ = this.var_481.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_481.getXML();
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1238:
               param2.setNumber(RoomObjectVariableEnum.const_690,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1155:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1241,int(param1.bgOnly));
         this.var_1476 = this._color;
         this.var_1841 = this.var_1839;
         this.var_1211 = _loc3_;
         this.var_1842 = _loc4_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_451,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1692,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1619,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1720,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_451,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_175 || _loc12_ == RoomPlaneData.const_314)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
