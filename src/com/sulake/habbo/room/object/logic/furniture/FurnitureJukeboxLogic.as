package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureJukeboxLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_609,RoomObjectFurnitureActionEvent.const_570,RoomObjectFurnitureActionEvent.const_468,RoomObjectFurnitureActionEvent.const_488,RoomObjectWidgetRequestEvent.const_131];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(object.getModelController().getNumber(RoomObjectVariableEnum.const_941) == 1)
         {
            object.getModelController().setString(RoomWidgetInfostandExtraParamEnum.const_503,RoomWidgetInfostandExtraParamEnum.const_724);
            ...
            if(_loc4_ != this.var_2144)
            {
               this.var_2144 = _loc4_;
               if(_loc4_ == 1)
               {
