package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureSoundMachineLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_589,RoomObjectFurnitureActionEvent.const_454,RoomObjectFurnitureActionEvent.const_610,RoomObjectFurnitureActionEvent.const_448];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != this.var_2144)
         {
            this.var_2144 = _loc3_;
            if(_loc3_ == 1)
            {
