package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureScoreBoardLogic extends FurnitureLogic
   {
      ...
      private static const const_972:int = 3000;
      ...
      private function updateScore(param1:int) : void
      {
         ...
         if(this.var_755 != _loc2_)
         {
            ...
            if(_loc3_ * const_440 > const_972)
            {
               this.var_1151 = const_972 / _loc3_;
            }
            else
            {
               this.var_1151 = const_440;
            }
      ...
      override public function update(param1:int) : void
      {
         ...
         if(object != null)
         {
            ...
            if(_loc2_ != this.var_755 && param1 >= this.var_1423 + this.var_1151)
            {
               _loc3_ = param1 - this.var_1423;
               _loc4_ = _loc3_ / this.var_1151;
               _loc5_ = 1;
               if(this.var_755 < _loc2_)
               {
                  _loc5_ = -1;
               ...
               this.var_1423 = param1 - (_loc3_ - _loc4_ * this.var_1151);
            }
         }
      }
   }
