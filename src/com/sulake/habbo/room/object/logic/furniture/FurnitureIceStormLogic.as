   ...
   public class FurnitureIceStormLogic extends FurnitureMultiStateLogic
   {
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         else
         {
            ...
            this.var_2264 = param1.extra;
            this.var_1100 = lastUpdateTime + _loc3_;
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1100 > 0 && param1 >= this.var_1100)
         {
            this.var_1100 = 0;
            _loc2_ = new RoomObjectDataUpdateMessage(this.var_1651,String(this.var_1651),this.var_2264);
