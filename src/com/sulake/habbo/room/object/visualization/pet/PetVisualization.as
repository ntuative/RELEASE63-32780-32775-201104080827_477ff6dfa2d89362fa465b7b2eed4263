package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization implements IPetImageListener
   {
      ...
      private const const_2058:int = 3;
      ...
      private var var_1817:Number = NaN;
      ...
      {
         this.var_683 = param1 as PetVisualizationData;
         createSprites(this.const_1352);
         var _loc2_:BitmapData = (this.var_683.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset).content as BitmapData;
      ...
      private function updateModel(param1:IRoomObjectModel, param2:Number) : Boolean
      {
         ...
         {
            this.var_2042 = param1.getNumber(RoomObjectVariableEnum.const_379) > 0;
            this.var_1465 = param1.getString(RoomObjectVariableEnum.const_135);
            this.var_282 = param1.getString(RoomObjectVariableEnum.const_261);
            this._postureParameter = param1.getString(RoomObjectVariableEnum.const_943);
            this.var_1817 = param1.getNumber(RoomObjectVariableEnum.const_195);
            this.var_1458 = param1.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2180 = param1.getNumber(RoomObjectVariableEnum.const_849);
            this.validateActions();
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_190);
            if(this.var_687 != _loc3_)
            {
               this.var_687 = _loc3_;
      ...
      private function updateObject(param1:IRoomObject, param2:IRoomGeometry, param3:Boolean = false) : Boolean
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param3 || var_469 != param1.getUpdateID() || this.var_1783 != param2.updateId)
         {
            _loc4_ = param1.getDirection().x - param2.direction.x;
            _loc4_ = (_loc4_ % 360 + 360) % 360;
            _loc5_ = this.var_1817;
            if(isNaN(this.var_1817))
            {
               _loc5_ = _loc4_;
            }
            else
            ...
            if(_loc4_ != this.var_2045 || param3)
            {
               this.var_2045 = _loc4_;
               _loc4_ -= 112.5;
      ...
      private function getAvatarImage(param1:Number) : IAvatarImage
      {
         ...
         if(_loc3_ == null)
         {
            _loc3_ = this.var_683.getAvatar(this.var_687,param1,this);
            if(_loc3_ != null)
            {
      ...
      private function updateShadow(param1:Number) : void
      {
         ...
         this.var_685 = null;
         _loc2_ = getSprite(this.const_1773);
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(param1 < 48)
         {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc10_ || _loc7_ != var_88 || this.var_60 == null)
         {
            if(_loc7_ != var_88)
            {
               var_88 = _loc7_;
         ...
         var _loc12_:Boolean = this.var_941 || this.var_1203 > 0 || this.var_1816;
         this.var_364.alpha = 0;
         if(this.var_1458 > 0)
         {
            _loc13_ = param2 - this.var_1458;
            if(_loc13_ < AvatarAction.const_982)
            {
               this.var_364.alpha = int(Math.sin(_loc13_ / 0 * 0) * 255);
               this.var_364.setExperience(this.var_2180);
               this.var_1203 = this.const_2058;
            }
            else
            {
               this.var_1458 = 0;
            }
            _loc14_ = getSprite(this.const_1805);
            if(_loc14_ != null)
            {
         ...
         if(_loc11_ || _loc12_)
         {
            ...
            _loc14_ = getSprite(this.const_1026);
            if(_loc14_)
            {
      ...
      private function updateActions(param1:IAvatarImage) : void
      {
         ...
         {
            param1.appendAction(AvatarAction.const_319,this.var_1465);
         }
