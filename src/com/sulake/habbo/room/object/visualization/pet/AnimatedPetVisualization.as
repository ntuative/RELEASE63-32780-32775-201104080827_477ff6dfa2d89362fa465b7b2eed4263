package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1347:String = "head";
      
      private static const const_629:int = 1;
      
      private static const const_982:int = 1000;
      
      private static const const_1349:String = "pet_experience_bubble_png";
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1349) as BitmapDataAsset;
            if(_loc3_ != null)
            {
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_261);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_135);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_261);
            if(!isNaN(_loc6_))
            {
            ...
            this.var_2042 = _loc3_.getNumber(RoomObjectVariableEnum.const_379) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_195);
            if(!isNaN(_loc8_))
            {
               this.var_1802 = _loc8_;
            }
            else
            {
               this.var_1802 = direction;
            }
            this.var_1458 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2180 = _loc3_.getNumber(RoomObjectVariableEnum.const_849);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_811);
            if(_loc9_ != this.var_1803)
            {
               this.var_1803 = _loc9_;
               this.var_2537 = this.var_1803.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_364 != null)
         {
            ...
            if(this.var_1458 > 0)
            {
               _loc2_ = param1 - this.var_1458;
               if(_loc2_ < const_982)
               {
                  this.var_364.alpha = int(Math.sin(_loc2_ / const_982 * 0) * 255);
                  this.var_364.setExperience(this.var_2180);
               }
               else
               {
                  this.var_1458 = 0;
      ...
      private function validateActions(param1:String, param2:String) : void
      {
         ...
         if(param1 != this.var_282)
         {
            ...
            this.setAnimationForIndex(const_1346,_loc3_);
         }
      ...
      {
         return super.getAdditionalSpriteCount() + const_629;
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2537);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_629)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_629))
            {
               if(param2 >= FurnitureVisualizationData.const_512.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_512[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_1802);
         }
         return direction;
      }
      ...
      private function isHeadSprite(param1:int) : Boolean
      {
         ...
         {
            if(this._animationData.getTag(var_88,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1347)
            {
               this.var_968[param1] = true;
            }
            else
            {
               this.var_968[param1] = false;
            }
         }
         return this.var_968[param1];
      }
   }
}
