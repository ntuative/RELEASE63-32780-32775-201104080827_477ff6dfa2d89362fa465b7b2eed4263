package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_1760:XMLList;
      
      private var _offsetX:int;
      
      private var var_1206:int;
      
      private var var_2232:Vector3d;
      ...
      private var var_1350:LayoutRasterizerData = null;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != this.var_888)
         {
            ...
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1350 = this.var_43.getValue(this.var_888);
         }
      }
      ...
      public function initialize(param1:XML) : void
      {
         ...
         this.var_2232 = new Vector3d(-0.5,0.5,0);
         this.var_887 = false;
      }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(this.var_2232);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc3_:LayoutRasterizerData = this.var_43.getValue(this.var_888);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_1646 = RoomObjectVariableEnum.const_1111;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_1646 = RoomObjectVariableEnum.const_1087;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1088 + this._adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1088 + this._adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      {
         var _loc1_:LayoutRasterizerData = this.var_43.getValue(this.var_888);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      {
         if(param2 == this.var_2233 && param3 == this.var_2231)
         {
            return;
         }
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(this.var_1088 + this._adBgIndex);
            _loc5_ = param1.getSprite(this.var_1088 + this._adImgIndex);
         }
         ...
         {
            this.exchangeElementGraphics("billboard_img",this.var_1646);
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = this.var_1350.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_409.indexOf(_loc10_) >= 0 && this.var_887)
            {
               param1 = this.var_409.indexOf(_loc10_);
               if(this.var_579[param1] != "")
               {
                  _loc9_ = this.var_762.getAsset(this.var_579[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               if(this.var_580[param1] != -1)
               {
                  param2.alpha = this.var_580[param1];
               }
