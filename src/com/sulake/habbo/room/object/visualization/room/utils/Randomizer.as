package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1887:int = 16777216;
      ...
      private var var_1935:int = 16777216;
      
      private var var_2924:int = 69069;
      ...
      {
         var _loc1_:int = this.var_2924 * this.var_1934 + this.var_2923;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1935;
         this.var_1934 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1935 * param2);
      }
   }
}
