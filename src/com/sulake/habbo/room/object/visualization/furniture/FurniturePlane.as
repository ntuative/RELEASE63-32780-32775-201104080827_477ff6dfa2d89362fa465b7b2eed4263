package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlane
   {
      ...
      private var var_831:Vector3d = null;
      ...
      public function FurniturePlane(param1:IVector3d, param2:IVector3d, param3:IVector3d)
      {
         ...
         this.var_830 = new Vector3d();
         this.var_830.assign(param2);
         this.var_831 = new Vector3d();
         this.var_831.assign(param3);
      ...
      {
         if(param1 != this.var_2810)
         {
            if(!param1)
            {
               this.var_322.assign(this.var_830);
               this.var_321.assign(this.var_831);
            }
            else
            {
               this.var_322.assign(this.var_830);
               this.var_322.mul(this.var_831.length / this.var_830.length);
               this.var_321.assign(this.var_831);
               this.var_321.mul(this.var_830.length / this.var_831.length);
            }
            this.var_1783 = -1;
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || this.var_92 == null && this.var_1118 != null || this.var_322 == null || this.var_321 == null || this.var_587 == null)
         {
            return false;
         }
         ...
         if(param1.updateId != this.var_1783)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != this.var_1545 || _loc4_.y != this.var_2205 || _loc4_.z != this.var_2207 || param1.scale != this.var_2210))
            {
               this.var_1545 = _loc4_.x;
               this.var_2205 = _loc4_.y;
               this.var_2207 = _loc4_.z;
               ...
               _loc6_ = param1.getScreenPosition(this.var_1118);
               _loc7_ = _loc6_.z;
               _loc8_ = Math.max(this.var_153.z - _loc7_,this.var_109.z - _loc7_,this.var_84.z - _loc7_,this.var_110.z - _loc7_);
               this.var_2327 = _loc8_;
