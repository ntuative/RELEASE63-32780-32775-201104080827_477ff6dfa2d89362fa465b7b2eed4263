package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystem
   {
      ...
      private var var_1229:Number = 1.0;
      
      private var var_638:BitmapData;
      
      private var var_790:ColorTransform;
      
      private var var_1487:ColorTransform;
      
      private var var_1876:Matrix;
      
      private var _translationMatrix:Matrix;
      
      private var var_740:Number = 1.0;
      ...
      public function FurnitureParticleSystem(param1:AnimatedFurnitureVisualization)
      {
         ...
         this.var_790 = new ColorTransform();
         this.var_790.alphaMultiplier = 1;
         this.var_1487 = new ColorTransform();
         this.var_1876 = new Matrix();
      ...
      public function setAnimation(param1:int) : void
      {
         ...
         this.var_95 = this.var_1228[param1];
         this.var_984 = false;
         this.updateCanvas();
      }
      ...
      private function updateCanvas() : void
      {
         ...
         if(this.var_1875 >= 0)
         {
            this.var_263 = this._visualization.getSprite(this.var_1875);
            if(this.var_263 && this.var_263.asset)
            {
               ...
               if(this.var_86 == null)
               {
                  ...
                  if(this.var_790.alphaMultiplier != 1)
                  {
                     this.var_638 = new BitmapData(this.var_86.width,this.var_86.height,true,4278190080);
                  }
               }
               this.var_2612 = -this.var_263.offsetX;
               this.var_2610 = -this.var_263.offsetY;
      ...
      public function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         {
            return this.var_95.y * this.var_1229;
         }
         return 0;
      }
      ...
      public function updateAnimation() : void
      {
         ...
         var _loc2_:* = 0;
         var _loc8_:int = 0;
         if(!this.var_984 && this.var_95.hasIgnited)
         {
            this.var_984 = true;
         }
         _loc8_ = this.var_1206 * this.var_1229;
         this.var_95.update();
         if(this.var_984)
         {
            if(this.var_95.roomObjectSpriteId >= 0)
            ...
            {
               this.var_86.draw(this.var_638,this.var_1876,this.var_790,BlendMode.NORMAL,null,false);
            }
            for each(_loc11_ in this.var_95.particles)
            {
               _loc2_ = Number(_loc11_.y);
               _loc3_ = this.var_2612 + (_loc11_.x - _loc11_.z) * 10 / 10 * this.var_1229;
               _loc4_ = this.var_2610 - _loc8_ + (_loc2_ + (_loc11_.x + _loc11_.z) / 2) * 10 / 10 * this.var_1229;
               ...
               if(_loc6_)
               {
                  ...
                  if(_loc11_.fade && _loc11_.alphaMultiplier < 1)
                  {
                     ...
                     this.var_1487.alphaMultiplier = _loc11_.alphaMultiplier;
                     this.var_86.draw(_loc7_,this._translationMatrix,this.var_1487,BlendMode.NORMAL,null,false);
                  }
                  else
                  {
      ...
      public function parseData(param1:XML) : void
      {
         ...
         this.var_1875 = !!param1.hasOwnProperty("@canvas_id") ? int(parseInt(param1.@canvas_id)) : -1;
         this.var_1206 = !!param1.hasOwnProperty("@offset_y") ? int(parseInt(param1.@offset_y)) : 10;
         this.var_1229 = this.var_2611 / 64;
         this.var_740 = !!param1.hasOwnProperty("@blend") ? Number(Number(param1.@blend)) : Number(1);
         this.var_740 = Math.min(this.var_740,1);
         this.var_790.alphaMultiplier = this.var_740;
