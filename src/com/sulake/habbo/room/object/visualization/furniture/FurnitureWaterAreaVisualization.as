package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1366:String = "shore";
      ...
      {
         if(this.var_2606 == param1 && this.var_2605 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1366)
            {
               this.var_1873 = _loc2_;
               this.var_2606 = param1;
               this.var_2605 = direction;
               return this.var_1873;
            }
            _loc2_--;
         }
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_1227.indexOf(_loc2_) < 0)
            {
      ...
      {
         var _loc2_:* = null;
         if(this.var_526 == 0 || this.var_637 == 0)
         {
            ...
            this.var_526 = _loc2_.getNumber(RoomObjectVariableEnum.const_329);
            this.var_637 = _loc2_.getNumber(RoomObjectVariableEnum.const_374);
         }
         this.var_437 = [];
         this.var_636 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_526 * 2 + this.var_637 * 2)
         {
            this.var_437.push(false);
            this.var_636.push(ShoreMaskCreatorUtility.const_78);
            _loc1_++;
         }
      }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_67,getSize(param3),this.var_437,this.var_636,assetCollection);
      }
