package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_710:FaqCategory;
      ...
      {
         super();
         this.var_712 = new FaqCategory(-999,"${help.faq.title.urgent}");
         this.var_711 = new FaqCategory(-9999,"${help.faq.title.normal}");
         this.var_710 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
      ...
      public function storeAnswerText(param1:int, param2:String) : void
      {
         ...
         if(this.var_711.hasItem(param1))
         {
            this.var_711.getItem(param1).answerText = param2;
         }
         if(this.var_710.hasItem(param1))
         {
            this.var_710.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(this.var_711.hasItem(param1))
         {
            return this.var_711.getItem(param1);
         }
         if(this.var_710.hasItem(param1))
         {
            return this.var_710.getItem(param1);
         }
         var _loc2_:int = 0;
