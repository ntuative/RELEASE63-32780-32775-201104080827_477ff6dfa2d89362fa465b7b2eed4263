package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201104080821));
         this.var_160 = param5;
         this.var_111 = new Map();
         this.var_111.add(HabboHelpViewEnum.const_1629,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_111.add(HabboHelpViewEnum.const_198,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_111.add(HabboHelpViewEnum.const_566,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_111.add(HabboHelpViewEnum.const_298,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_111.add(HabboHelpViewEnum.const_251,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_111.add(HabboHelpViewEnum.const_391,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_111.add(HabboHelpViewEnum.const_937,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_111.add(HabboHelpViewEnum.const_265,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_111.add(HabboHelpViewEnum.const_1083,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_111.add(HabboHelpViewEnum.const_1034,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_111.add(HabboHelpViewEnum.const_914,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_497.length == 0 || param1 != this.var_347)
            {
               this.var_497.push(this.var_347);
            }
         }
         this.var_347 = param1;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            ...
            case CallForHelpResultEnum.const_1248:
               ...
               break;
            case CallForHelpResultEnum.const_1063:
               this.showUI(HabboHelpViewEnum.const_1083);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_111.getValue(HabboHelpViewEnum.const_198) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_553));
      }
      ...
      {
         return this.var_111.getValue(this.var_347);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2373 = this._window.width - _loc3_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2375;
         this._window.width = _loc1_.width + this.var_2373;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_497.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_347 == HabboHelpViewEnum.const_198)
         {
            return;
         }
         if(this.var_596.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_596.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_596[1],this.var_596[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_596[0],this.var_596[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_347 == HabboHelpViewEnum.const_198 || this.var_497.length == 0)
         {
            return;
         }
         if(this.var_346 == null)
