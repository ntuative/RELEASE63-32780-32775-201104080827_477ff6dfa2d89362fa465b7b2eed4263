package com.sulake.habbo.help
{
   ...
   public class WelcomeScreenController implements IUpdateReceiver
   {
      ...
      {
         return this._notifications[this.var_1342];
      }
      ...
      public function dispose() : void
      {
         if(this.var_130)
         {
            ...
            this.var_130.toolbar.events.removeEventListener(HabboToolbarEvent.const_36,this.onToolbarClicked);
            this.var_130.toolbar.events.removeEventListener(HabboToolbarEvent.const_827,this.onToolbarResized);
            this.var_130 = null;
         }
         ...
         {
            this.var_716.stop();
            this.var_716.removeEventListener(TimerEvent.TIMER,this.onReminderTimer);
            this.var_716 = null;
         }
      ...
      public function showWelcomeScreen(param1:Boolean) : void
      {
         ...
         this.var_130.toolbar.events.addEventListener(HabboToolbarEvent.const_36,this.onToolbarClicked);
         this.var_130.toolbar.events.addEventListener(HabboToolbarEvent.const_827,this.onToolbarResized);
         var _loc4_:int = parseInt(this._config.getKey("welcome.screen.delay","5000"));
         this.var_716 = new Timer(_loc4_);
         this.var_716.addEventListener(TimerEvent.TIMER,this.onReminderTimer);
         this.var_716.start();
      }
      ...
      public function onReminderTimer(param1:TimerEvent) : void
      {
         ...
         this.var_216.y = this.var_130.toolbar.getIconLocation(this.current.targetIconId) - this._window.height / 2;
      ...
      {
         var _loc1_:XmlAsset = this.var_130.assets.getAssetByName("welcome_screen_xml") as XmlAsset;
         ...
         var _loc3_:BitmapDataAsset = this.var_130.assets.getAssetByName("welcome_screen_arrow") as BitmapDataAsset;
         ...
         _loc4_.content.setParamFlag(WindowParam.const_327,false);
         _loc4_.height -= 20;
      ...
      private function closeWindow() : void
      {
         ...
         if(this.var_1342 < this._notifications.length - 1)
         {
            ++this.var_1342;
         }
         else
