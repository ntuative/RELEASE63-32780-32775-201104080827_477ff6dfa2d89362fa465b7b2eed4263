package com.sulake.habbo.help.tutorial
{
   ...
   public class NameSuggestionListRenderer
   {
      ...
      private const const_2060:int = 5;
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(this.var_1206 + param1.height > this.var_1207.height)
         {
            return false;
         }
         ...
         {
            this._offsetX = 0;
            this.var_1206 += param1.height + this.const_2059;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1206);
         this._offsetX += param1.width + this.const_2060;
         return true;
      }
