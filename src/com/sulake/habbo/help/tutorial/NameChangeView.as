package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1798:uint = 11129827;
      ...
      private var var_1193:NameSuggestionListRenderer;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1796 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_768)
         {
            this.var_768 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_768)
            {
               return;
            }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this._controller.localization.registerParameter("help.tutorial.name.available","name",this.var_517);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1056 || param1 == ChangeUserNameResultMessageEvent.var_1058)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1193 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1193.render(param3,_loc5_);
         var _loc7_:int = 0;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_517 = this._controller.myName;
               this.showConfirmationView();
               break;
            ...
            case "confirm_name_button":
               this._controller.changeName(this.var_517);
               break;
