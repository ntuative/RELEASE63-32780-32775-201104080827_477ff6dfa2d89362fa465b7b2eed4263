package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1483:int = 2;
      ...
      private var var_1861:TriggerConfs;
      
      private var var_1859:ActionTypes;
      
      private var var_1860:ConditionTypes;
      
      private var var_261:Dictionary;
      
      private var var_36:Triggerable;
      
      private var var_779:RoomObjectHightLighter;
      ...
      {
         this.var_1861 = new TriggerConfs();
         this.var_1859 = new ActionTypes();
         this.var_1860 = new ConditionTypes();
         this.var_261 = new Dictionary();
         super();
         this.var_79 = param1;
         this.var_779 = new RoomObjectHightLighter(param1);
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1222 = new SliderWindowController(this.var_79,IWindowContainer(this.find(this.var_51,"delay_slider_container")),this.var_79.assets,0,20,1);
         this.var_1222.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1222.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_779.hideAll(this.var_261);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_779.showAll(this.var_261);
         if(this.var_36 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_36);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1222.setValue(_loc6_);
         }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1222.getValue()) : 0;
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = this.var_36.stuffTypeSelectionCode < 1 ? int(var_1483) : int(this.var_36.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = (this.var_36.stuffTypeSelectionCode + 1) % (var_1483 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
