package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1191,param1);
         this.var_965 = param1;
         if(param2)
         {
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_965);
         }
      ...
      {
         return int(this.var_1590 * (Number(param1 - this._minValue) / (this.var_1191 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1590 * (this.var_1191 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_964)
         {
            if(param1.type == WindowMouseEvent.const_58 || param1.type == WindowMouseEvent.const_191)
            {
               this.var_964 = false;
            }
         }
         if(!this.var_964 || param1.type != WindowEvent.const_253)
         {
            return;
         }
         if(this.var_621 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_621) * this.var_621;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_621 != 0)
            {
               _loc3_ = this.var_965 + this.var_621;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc2_ != null && this.var_700 != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_700.width,this.var_700.height,true,16777215);
            _loc2_.bitmap.copyPixels(this.var_700,this.var_700.rect,new Point(0,0),null,null,true);
         }
         ...
         if(_loc1_ != null)
         {
            ...
            {
               _loc2_.bitmap = new BitmapData(this.var_701.width,this.var_701.height,true,16777215);
               _loc2_.bitmap.copyPixels(this.var_701,this.var_701.rect,new Point(0,0),null,null,true);
               _loc2_.procedure = this.sliderProcedure;
               this.var_1590 = _loc1_.width - _loc2_.width;
            }
         }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_700 = BitmapData(_loc2_.content);
         _loc2_ = BitmapDataAsset(param1.getAssetByName("slider_obj_png"));
         this.var_701 = BitmapData(_loc2_.content);
      }
   }
}
