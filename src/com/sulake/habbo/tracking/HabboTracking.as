package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_1015:uint = 11;
      ...
      private var var_1277:IHabboWindowManager;
      ...
      private var var_674:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_674 = new ToolbarClickTracker(this);
         this.var_1551 = new Array(const_1015);
         var _loc4_:int = 0;
         while(_loc4_ < const_1015)
         {
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1721,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1453,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1552,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_916,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1119,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1277)
            {
               this.var_1277.release(new IIDHabboWindowManager());
               this.var_1277 = null;
            }
            if(this.var_307)
            {
            ...
            if(this.var_211)
            {
               if(!this.var_211.disposed)
               {
                  ...
                  Component(this.var_211).events.removeEventListener(HabboFriendListTrackingEvent.const_405,this.onFriendlistTrackingEvent);
               }
            ...
            if(this.var_160)
            {
               ...
               {
                  this.var_160.events.removeEventListener(HabboToolbarEvent.const_36,this.onToolbarClick);
               }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_190)
         {
            if(this.var_275 != null)
            {
               this.var_275.configuration = this.var_190;
            }
            if(this.var_276 != null)
            {
               this.var_276.configuration = this.var_190;
            }
            ...
            if(this.var_190)
            {
               ...
               {
                  this.var_673.configure(this.var_190);
               }
               if(this.var_457 != null)
               {
                  this.var_457.configure(this.var_190);
               }
               if(this.var_674 != null)
               {
                  this.var_674.configure(this.var_190);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_930,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_761,this.onHotelViewEvent);
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_761)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1474);
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1464);
               break;
            case HabboCommunicationEvent.const_930:
               this.trackLoginStep(HabboLoginTrackingStep.const_1590,String(this._communication.port));
               break;
      ...
      {
         this.var_1277 = IHabboWindowManager(param2);
         if(this.var_1277)
         {
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1043);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1043,this.onCoreRunning);
         }
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_211).events.addEventListener(HabboFriendListTrackingEvent.const_405,this.onFriendlistTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2817)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1696);
            this.var_2817 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1119,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_916,String(true));
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_307.events.addEventListener(AdEvent.const_506,this.onRoomAdLoad);
      }
      
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_160 = param2 as IHabboToolbar;
         this.var_160.events.addEventListener(HabboToolbarEvent.const_36,this.onToolbarClick);
      }
      ...
      private function onRoomAction(param1:RoomEngineEvent) : void
      {
         ...
         else if(param1.type == RoomEngineEvent.const_312)
         {
            if(this.var_323)
            {
               this.var_323.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_457)
               {
                  ...
                  this._connection.send(new ConversionPointMessageComposer("Performance","fps",String(this.var_457.frameRate),_loc2_));
                  ++this.var_2008;
               }
            }
         }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_674)
         {
            this.var_674.track(param1.iconName);
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++this.var_2007;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_2007);
         }
         if(this.var_550 > -1 && _loc2_ - this.var_550 > 15000)
         {
            ++this.var_2006;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_2006);
         }
         this.var_550 = _loc2_;
         if(this.var_276 != null)
         {
            this.var_276.update(param1,this.var_550);
         }
         if(this.var_275 != null)
         {
            this.var_275.update(param1,this.var_550);
         }
         if(this.var_457 != null)
         {
            this.var_457.trackUpdate(param1,this,this.var_550);
         }
         if(this.var_673 != null)
         {
            this.var_673.update(this.var_550);
         }
      }
   }
}
