package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_372:String = "pets";
      ...
      private var var_1694:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_590 = new Timer(const_1297,1);
         ...
         this.var_2339 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_46)
            {
               ...
               {
                  this.var_1694 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1694;
            }
            else
            {
         ...
         while(_loc13_ < param2.length)
         {
            ...
            if(_loc9_.indexOf(_loc6_.stripId) > -1)
            {
               ...
               {
                  _loc5_ = new FloorItem(_loc6_.stripId,_loc6_.classId,_loc6_.objId,_loc6_.category,_loc6_.isGroupable,_loc6_.isTradeable,_loc6_.isRecyclable,_loc6_.isSellable,_loc6_.stuffData,_loc6_.extra,_loc6_.method_1,0,0,0,_loc6_.slotId,_loc6_.songId);
               }
               else
               {
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_286)
         {
         ...
         if(this.var_918 == null)
         {
            this.var_918 = this._windowManager.buildFromXML(this.var_2339) as IWindowContainer;
         }
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_589.add(const_50,new Array());
         if(this._view != null)
         {
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_306 || _loc3_.category == FurniCategory.const_286 || _loc3_.category == FurniCategory.const_302)
         {
            if(param1)
            {
               return false;
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_729)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
