package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < this.var_1046.length)
         {
            if(this.var_1046[_loc2_] == param1)
            {
      ...
      public function updateBadge(param1:String, param2:Boolean) : void
      {
         ...
         else
         {
            ...
            _loc8_.iconImage = this.var_410.getBadgeImage(param1);
      ...
      {
         if(param1 == InventoryCategory.const_308 && this._controller.isVisible)
         {
