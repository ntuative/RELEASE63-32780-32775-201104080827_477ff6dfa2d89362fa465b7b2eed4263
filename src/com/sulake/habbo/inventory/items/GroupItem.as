package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2882:BitmapData;
      
      private const const_2061:int = 8947848;
      
      private const const_2062:int = 13421772;
      
      private const const_1802:Number = 1;
      
      private const const_1801:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this._type = param1;
         this._window = param4;
         this.var_1494 = this._window.findChildByTag("BG_COLOR");
         this._roomEngine = param5;
         this.var_2882 = param6;
         this.var_2109 = param7;
         this._items = new Map();
         this.var_2883 = param2;
         this._category = param3;
         this.var_2093 = param8;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2883 == FurniModel.const_46)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1363));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2093);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_729)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1801;
               _loc1_.blend = this.const_1801;
            }
            else
            {
         ...
         if(this.isSelected)
         {
            this.var_1494.color = this.const_2061;
         }
         else
         {
            this.var_1494.color = this.const_2062;
         }
