package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_2055:int = 500;
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_50.getValue(InventoryCategory.const_80));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_50.getValue(InventoryCategory.const_737));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_50.getValue(InventoryCategory.const_308));
      }
      ...
      public function get achievementsModel() : AchievementsModel
      {
         ...
         return AchievementsModel(this.var_50.getValue(InventoryCategory.const_422));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_50.getValue(InventoryCategory.const_385) as MarketplaceModel;
      }
      ...
      {
         this.var_410 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_410 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_15 || !this.var_160 || !this._soundManager)
         {
            return;
         }
         this._view = new InventoryMainView(this,this._windowManager,this._assetLibrary);
         this._view.setToolbar(this.var_160);
         this.var_50 = new Map();
         ...
         this.var_50.add(InventoryCategory.const_385,_loc1_);
         ...
         this.var_50.add(InventoryCategory.const_80,_loc2_);
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_410);
         this.var_50.add(InventoryCategory.const_308,_loc3_);
         ...
         this.var_50.add(InventoryCategory.const_737,_loc4_);
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_410);
         this.var_50.add(InventoryCategory.const_422,_loc5_);
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_953.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_953.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_953.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_953.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2055);
         }
      }
