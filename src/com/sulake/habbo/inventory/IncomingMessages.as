   ...
   public class IncomingMessages
   {
      ...
      public function onFurniListInsert(param1:IMessageEvent) : void
      {
         ...
         while(_loc7_ < _loc6_.length)
         {
            ...
            {
               _loc4_ = new FloorItem(_loc5_.stripId,_loc5_.classId,_loc5_.objId,_loc5_.category,_loc5_.isGroupable,_loc5_.isTradeable,_loc5_.isRecyclable,_loc5_.isSellable,_loc5_.stuffData,_loc5_.extra,_loc5_.method_1,0,0,0,_loc5_.slotId,_loc5_.songId);
            }
            else
            {
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_737);
         _loc2_.refreshViews();
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_308);
      }
