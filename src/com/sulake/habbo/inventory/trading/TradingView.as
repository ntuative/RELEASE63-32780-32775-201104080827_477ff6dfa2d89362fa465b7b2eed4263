package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_991:uint = 4284532064;
      
      private static const const_992:uint = 2577770;
      
      public static const const_1160:int = 0;
      
      public static const const_1120:int = 1;
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1880 = this.createMinimizedWindow();
         }
         if(!this.var_2615)
         {
            return this.var_70;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_70)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_18.ownUserAccepts ? uint(const_991) : uint(const_992);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_18.otherUserAccepts ? uint(const_991) : uint(const_992);
            }
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1478)
            {
            ...
            this.var_640.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_535);
            this.var_640.show();
         }
      ...
      private function getTraxSongFurniName(param1:GroupItem, param2:String, param3:Boolean, param4:uint = 1.0, param5:Boolean = false) : String
      {
         ...
         else if(param3)
         {
            ...
            this.var_180.push(param4);
            this.var_180.push(param1);
            this.var_180.push(param5);
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_180.length > 0)
         {
            _loc2_ = this.var_180.pop();
            _loc3_ = this.var_180.pop();
            _loc4_ = uint(this.var_180.pop());
            _loc5_ = _loc3_.peek();
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_18.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_18.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_640.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_535);
               }
            }
            else
            {
               this.var_180.push(_loc4_);
               this.var_180.push(_loc3_);
