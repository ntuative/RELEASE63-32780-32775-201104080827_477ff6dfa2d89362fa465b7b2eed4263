package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_45:
               this.var_1472.setSelectedGridItem(this);
               this.var_1471 = true;
               break;
            ...
            case WindowMouseEvent.const_28:
               ...
               {
                  this.var_1471 = false;
                  this.var_1472.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         this.var_1494.color = !!this._isSelected ? uint(this.const_2061) : uint(this.const_2062);
      }
