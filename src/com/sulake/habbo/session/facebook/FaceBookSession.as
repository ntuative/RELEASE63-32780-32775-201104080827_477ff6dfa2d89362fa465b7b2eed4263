package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_987:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1350:String = "sendAccessTokenToServer";
      
      private static const const_1351:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1350,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1351,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_987);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_987);
         }
      }
