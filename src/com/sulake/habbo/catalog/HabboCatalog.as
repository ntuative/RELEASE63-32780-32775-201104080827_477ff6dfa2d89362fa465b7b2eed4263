package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private static const const_612:uint = 1;
      ...
      private var var_1076:IRoomSession;
      ...
      private var var_173:CatalogViewer;
      
      private var var_336:ICatalogNavigator;
      ...
      private var var_2157:GiftWrappingConfiguration;
      
      private var var_1079:ClubGiftController;
      ...
      private var var_876:IPurchasableOffer;
      
      private var var_1334:IDragAndDropDoneReceiver;
      
      private var var_82:PlacedObjectPurchaseData;
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         if(param1 is Offer)
         {
            ...
            this.var_214.showOffer(this,param1,param2,param3,_loc5_);
            if(param4)
            {
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_336.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      {
         return this.var_410.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_410.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_74)
         {
            _loc3_ = this.var_410.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Array = this.var_703.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_100.getActivityPointsForType(Purse.const_212)));
         var _loc1_:int = 0;
      ...
      {
         this.var_160.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_126,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_771)
         {
            if(!this.var_410.loadProductData(this))
            {
               return;
            }
            this.init();
         ...
         if(this.var_160 != null && _loc2_)
         {
            this.var_160.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_59,HabboToolbarIconEnum.CATALOGUE,this._mainContainer));
         }
         if(this.mainWindowVisible())
         {
         ...
         this.setupInventoryForRecycler(this.var_89.active && this.mainWindowVisible());
      }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_173.getCurrentLayoutCode();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_336 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_173 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_173.habboCatalog = this;
      }
      
      private function createMainWindow() : void
      {
         var _loc1_:XmlAsset = assets.getAssetByName("catalog") as XmlAsset;
         this._mainContainer = this._windowManager.buildFromXML(_loc1_.content as XML,const_612) as IWindowContainer;
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_85:
               this.var_1610 = param1.session.isPrivateRoom;
               this.var_1076 = param1.session;
               if(this.var_89 != null)
               {
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1079 = new ClubGiftController(this);
         }
      }
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_173 != null)
         {
            this.var_173.catalogWindowClosed();
         }
         if(this.var_89 != null && this.getCurrentLayoutCode() == "recycler")
         {
            this.var_89.cancel();
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_336.buildCatalogIndex(_loc2_);
         if(this.var_704 && this.var_704 != "")
         {
            this.var_336.openPage(this.var_704);
            this.var_704 = "";
            this.var_875 = -1;
         }
         else if(this.var_875 > -1)
         {
            this.var_336.openPageById(this.var_875,this.var_1611);
            this.var_875 = -1;
            this.var_1611 = -1;
            this.var_704 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_173.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      private function onApproveNameResult(param1:ApproveNameMessageEvent) : void
      {
         ...
         this.var_173.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result,_loc2_.nameValidationInfo));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2156 && this._soundManager != null)
         {
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_70,this.var_100.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2158 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1078);
         }
         this.var_2158 = false;
         if(this.var_289 != null)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1079.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_173.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2157 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_703.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_703.add(_loc2_.productCode,_loc3_.slice());
            this.var_173.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
      ...
      public function requestSelectedItemToMover(param1:IDragAndDropDoneReceiver, param2:Offer) : void
      {
         ...
         if(!this.var_1076 || !this.var_1076.isRoomOwner)
         {
            return;
         }
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         if(this.var_1080 && param1.type == RoomEngineObjectEvent.const_179)
         {
            this.resetPlacedOfferData();
            if(this.var_876 == null || !param1.placedInRoom)
            {
               this.resetObjectMover();
               return;
            }
            this.var_82 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_876);
            _loc2_ = this.var_1334;
            this.resetObjectMover();
            if(_loc2_ != null)
            {
            ...
            _loc4_ = this.var_876.productContainer.firstProduct;
            ...
            if(_loc5_)
            {
               _loc5_.getModelController().setNumber(RoomObjectVariableEnum.const_324,0.5);
            }
         }
      }
      ...
      public function resetPlacedOfferData() : void
      {
         if(this.var_82 != null)
         {
            if(this.var_82.category == RoomObjectCategoryEnum.const_27)
            {
               this._roomEngine.disposeObjectFurniture(this.var_82.roomId,this.var_82.roomCategory,this.var_82.objectId);
            }
            else if(this.var_82.category == RoomObjectCategoryEnum.const_25)
            {
               this._roomEngine.disposeObjectWallItem(this.var_82.roomId,this.var_82.roomCategory,this.var_82.objectId);
            }
            else
            {
               this._roomEngine.deleteRoomObject(this.var_82.objectId,this.var_82.category);
            }
            this.var_82.dispose();
            this.var_82 = null;
         }
      ...
      private function onItemAddedToInventory(param1:HabboInventoryItemAddedEvent) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         if(this.var_82 && this.var_82.productClassId == param1.classId)
         {
            if(this.var_82.roomCategory == this._roomEngine.activeRoomCategory && this.var_82.roomId == this._roomEngine.activeRoomId)
            {
               _loc2_ = param1.stripId;
               _loc3_ = this.var_82.category;
               _loc4_ = this.var_82.wallLocation;
               _loc5_ = this.var_82.x;
               _loc6_ = this.var_82.y;
               _loc7_ = this.var_82.direction;
               ...
               if(param1.category == FurniCategory.const_306 || param1.category == FurniCategory.const_286 || param1.category == FurniCategory.const_302)
               {
      ...
      private function showMainWindow() : void
      {
         ...
         {
            _loc1_ = this._windowManager.getDesktop(const_612);
            if(_loc1_ != null)
            {
