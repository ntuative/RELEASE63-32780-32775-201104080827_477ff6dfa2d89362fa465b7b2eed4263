package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2896:String = "magic.pixels";
      
      private var var_2897:String = "catalog.page.club";
      ...
      {
         this.openPage(this.var_2896);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_2897,true);
      }
