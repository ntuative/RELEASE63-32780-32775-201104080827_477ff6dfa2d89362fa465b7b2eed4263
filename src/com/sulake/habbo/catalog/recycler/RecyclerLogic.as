package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_974:int = 0;
      ...
      {
         return this.var_609 != const_974;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1754 != RecyclerStatusMessageEvent.const_1098;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_609 == const_435;
      }
      ...
      {
         this.var_609 = const_973;
         this.var_114 = new Array(const_185);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1754)
         {
            case RecyclerStatusMessageEvent.const_1637:
               this.var_609 = const_435;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1098:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1052:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1677:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_114.length < const_185)
         {
            return false;
         }
         var _loc1_:int = 0;
