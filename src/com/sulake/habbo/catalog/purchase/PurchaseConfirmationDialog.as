package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_2043:int = 10;
      ...
      private const const_1793:uint = 4.293848814E9;
      
      private const const_1792:uint = 4.294967295E9;
      
      private const const_2044:uint = 4.291613146E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1685 = _loc1_.stuffTypes;
            this.var_749 = _loc1_.boxTypes;
            this.var_748 = _loc1_.ribbonTypes;
            this.var_1140 = this.var_1685[0];
            this.var_350 = this.var_749[0];
            this.var_351 = this.var_748[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_351 < 0)
         {
            this.var_351 = this.var_748.length - 1;
         }
         if(this.var_351 > this.var_748.length - 1)
         {
            this.var_351 = 0;
         }
         if(this.var_350 < 0)
         {
            this.var_350 = this.var_749.length - 1;
         }
         if(this.var_350 > this.var_749.length - 1)
         {
            this.var_350 = 0;
         }
         var _loc1_:int = this.var_749[this.var_350] * 1000 + this.var_748[this.var_351];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_90.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1140,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1412 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1685;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1140);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_749[this.var_350]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_748[this.var_351]);
         this._catalog.purchaseProductAsGift(this.var_1413,this.var_90,this.var_1414,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this.var_1413,this.var_90.offerId,this.var_1414);
               this.dispose();
               break;
            case "cancel_button":
         ...
         switch(param1.type)
         {
            case WindowEvent.const_107:
               ...
               for each(_loc7_ in this.var_227)
               {
                  ...
                  if(_loc5_.length >= this.const_2043)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2411 = _loc3_.text;
               break;
            case WindowMouseEvent.const_45:
               ...
               break;
            case WindowKeyboardEvent.const_366:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     this.highlightSuggestion(this.var_352 - 1);
                     break;
                  case Keyboard.DOWN:
                     this.highlightSuggestion(this.var_352 + 1);
                     break;
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_352) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_254 == null || this.var_606 == null)
         {
            return;
         }
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_352) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_352);
         }
         this.var_352 = param1;
         if(this.var_352 < 0)
         {
            this.var_352 = _loc2_.numListItems - 1;
         }
         if(this.var_352 >= _loc2_.numListItems)
         {
            this.var_352 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_352) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_2044;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1793) : uint(this.const_1792);
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1140;
               }
            }
            _loc4_++;
         }
