package com.sulake.habbo.catalog.purchase
{
   ...
   public class PlacedObjectPurchaseData implements IDisposable
   {
      ...
      private var var_1977:IProductData;
      ...
      private function setOfferData(param1:IPurchasableOffer) : void
      {
         ...
         this.var_1977 = param1.productContainer.firstProduct.productData;
         this.var_589 = param1.productContainer.firstProduct.furnitureData;
      }
      
      public function toString() : String
      {
         return [this._roomCategory,this._roomId,this.var_358,this._category,this.var_1975,this._x,this.var_147,this._direction,this._offerId,this.var_1974].toString();
      }
