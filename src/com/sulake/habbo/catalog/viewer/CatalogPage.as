package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1748:String = "ctlg_";
       
      
      protected var var_2094:XML;
      ...
      private var var_495:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1127:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_495 = new EventDispatcher();
      ...
      {
         var _loc2_:String = const_1748 + param1;
         ...
         this.var_2094 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2094) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1673:
               if(this.var_1127 == null)
               {
                  this.var_1127 = new ItemGridCatalogWidget(param1);
                  this.var_35.push(this.var_1127);
               }
               break;
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_495.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_495 != null)
         {
            return this.var_495.dispatchEvent(param1);
         }
         return false;
      }
