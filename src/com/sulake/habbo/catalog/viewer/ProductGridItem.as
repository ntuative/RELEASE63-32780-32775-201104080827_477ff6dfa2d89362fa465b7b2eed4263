package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_1004:String = "bg";
       
      
      protected var _view:IWindowContainer;
      
      private var var_242:IItemGrid;
      ...
      {
         this._view.getChildByName(const_1004).style = HabboWindowStyle.const_30;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_1004).style = 3;
      }
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_45)
         {
            ...
            this.var_242.select(this);
            this.var_574 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_28 && this.var_574 != null && this.var_574 == param2)
         {
            _loc3_ = this.var_242.startDragAndDrop(this);
            if(_loc3_)
            {
               this.var_574 = null;
            }
