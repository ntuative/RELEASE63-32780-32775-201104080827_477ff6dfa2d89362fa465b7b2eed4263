   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function init() : Boolean
      {
         ...
         if(_loc1_ != null)
         {
            ...
            for each(_loc2_ in page.offers)
            {
               ...
               switch(_loc4_.furnitureData.name)
               {
                  case "floor":
                     ...
                     {
                        this.var_1048.push(String(_loc9_.@id));
            ...
            events.dispatchEvent(new CatalogWidgetUpdateRoomPreviewEvent(this._floorType,this.var_1570,this.var_1567,64));
            return true;
         }
         return false;
      }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1568[this.var_464];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_floor_color_next":
               ...
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1571[this.var_463];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               _loc3_ = this.var_1569[this.var_461];
               if(_loc3_ != null)
               {
      ...
      private function updateConfiguration() : void
      {
         ...
         for each(_loc1_ in this.var_190.walls.pattern)
         {
            if(_loc1_.@id == _loc2_)
            {
               if(this.var_462 >= 0)
               {
                  _loc9_ = _loc1_.children()[this.var_462];
                  if(_loc9_ != null)
                  {
         ...
         var _loc5_:String = this.var_1048[this.var_463];
         for each(_loc1_ in this.var_190.floors.pattern)
         {
            if(_loc1_.@id == _loc5_)
            {
               _loc11_ = _loc1_.children()[this.var_555];
               if(_loc11_ != null)
               {
         ...
         _loc6_ = this.var_1571[this.var_463];
         if(_loc6_ != null)
         {
         ...
         var _loc7_:String = this.var_1051[this.var_461];
         for each(_loc1_ in this.var_190.landscapes.pattern)
         {
            if(_loc1_.@id == _loc7_)
            {
               _loc13_ = _loc1_.children()[this.var_556];
               if(_loc13_ != null)
               {
         ...
         _loc8_ = this.var_1569[this.var_461];
         if(_loc8_ != null)
         {
         ...
         switch(param1)
         {
            case const_223:
               ...
               for each(_loc8_ in this.var_190.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     this.var_1050 = _loc8_.children().length();
                  }
               }
            ...
            case const_222:
               ...
               if(this.var_463 < 0)
               {
                  this.var_463 = this.var_1048.length - 1;
               }
               if(this.var_463 >= this.var_1048.length)
               {
                  this.var_463 = 0;
               }
               this.var_555 = 0;
               this.var_1049 = 0;
               _loc6_ = this.var_1048[this.var_463];
               for each(_loc9_ in this.var_190.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
            ...
            case TYPE_LANDSCAPE:
               ...
               if(this.var_461 < 0)
               {
                  this.var_461 = this.var_1051.length - 1;
               }
               if(this.var_461 >= this.var_1051.length)
               {
                  this.var_461 = 0;
               }
               this.var_556 = 0;
               this.var_1047 = 0;
               _loc7_ = this.var_1051[this.var_461];
               for each(_loc10_ in this.var_190.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     this.var_1047 = _loc10_.children().length();
                  }
               }
