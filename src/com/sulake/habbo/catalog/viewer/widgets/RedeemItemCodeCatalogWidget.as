package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_996.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_996 = null;
         }
         if(this.var_997 != null)
         {
            this.var_997.removeEventListener(WindowKeyboardEvent.const_182,this.windowKeyEventProcessor);
            this.var_997 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_996 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_996 != null)
         {
            this.var_996.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_997 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_997 != null)
         {
            this.var_997.addEventListener(WindowKeyboardEvent.const_182,this.windowKeyEventProcessor);
         }
         return true;
      }
