   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_210 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1382 && _loc2_ < this.var_210.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_531,this.var_210[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_210 != null && this.var_210.length > 0)
         {
            ...
            this.var_376 = this.var_210[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_531,this.var_376),this.getRaceLocalizationKey(this.var_531,this.var_376));
            }
         }
         return this.getRaceLocalizationKey(this.var_531,this.var_376);
      }
