package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      {
         var _loc2_:Offer = this.var_217[this.var_581][this.var_721];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_581 = var_471.getGridItemIndex(param1.view);
      ...
      override protected function populateItemGrid() : void
      {
         ...
         {
            if(this.var_721 < _loc1_.length)
            {
               _loc2_ = _loc1_[this.var_721] as Offer;
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_426 || _loc1_.pricingModel == Offer.const_384)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_74 || _loc3_.productType == ProductTypeEnum.const_82)
                  {
