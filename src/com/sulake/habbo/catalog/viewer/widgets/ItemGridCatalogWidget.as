   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_743,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_237,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_702,this.deActivateScrollbar);
      ...
      protected function loadItemGridGraphics(param1:TimerEvent = null) : void
      {
         ...
         while(_loc2_ < 3)
         {
            if(this.var_774 >= 0 && this.var_774 < page.offers.length)
            {
               _loc3_ = page.offers[this.var_774];
               this.loadGraphics(_loc3_);
               _loc3_.productContainer.grid = this;
            }
            ++this.var_774;
            if(this.var_774 >= page.offers.length)
            {
               this.resetTimer();
               break;
            }
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         {
            ++this.var_1824;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_1824);
         }
      }
