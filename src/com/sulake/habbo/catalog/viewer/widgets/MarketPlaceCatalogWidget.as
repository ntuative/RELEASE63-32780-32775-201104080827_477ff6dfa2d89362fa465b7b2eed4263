package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_2074:int = 40;
      
      private const const_2075:int = 10;
      
      private var var_841:Array;
      
      private var var_1553:MarketPlaceOfferData;
      ...
      private function updateList() : void
      {
         ...
         if(!this.var_676)
         {
            ...
            this.var_676 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!this.var_676)
         {
            return;
         ...
         this.updateStatusDisplay(this.const_1774,_loc2_.length);
         if(!this.var_553)
         {
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(this.var_1278 >= this._offers.length)
            {
               return true;
            }
            this.addListItem(this._offers.getWithIndex(this.var_1278));
            ++this.var_1278;
            _loc1_++;
         }
         return false;
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !this._itemList || !this.var_676 || !this.marketPlace.localization)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_676.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         this.updateStatusDisplay(this.const_1775);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  this.marketPlace.buyOffer(this.var_1553.offerId);
            }
            return;
         }
         if(param1.type == WindowEvent.const_57)
