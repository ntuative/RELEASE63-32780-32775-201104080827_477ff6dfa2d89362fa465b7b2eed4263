package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_947:ITextWindow;
      
      private var var_1150:ITextWindow;
      
      private var var_85:IBitmapWrapperWindow;
      
      private var var_1752:Point;
      
      private var var_508:IItemGridWindow;
      
      private var var_1422:IScrollbarWindow;
      
      protected var var_1854:XML;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_947 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1150 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_85 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1752 = new Point(this.var_85.x,this.var_85.y);
         this.var_508 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1422 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1751 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_947.text = _loc4_;
         this.var_1150.text = _loc5_;
         this.var_947.height = this.var_947.textHeight + 5;
         this.var_1150.y = this.var_947.y + this.var_947.height;
         this.var_1150.height = Math.max(130,this.var_1150.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_513:
                  _loc6_ = this.var_1751.clone();
                  if(this.var_508 != null)
                  {
                     this.var_508.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_508,this.var_1422,this.var_1854);
                     this.var_508.scrollV = 0;
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_201:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_319,AvatarAction.const_498);
                              _loc16_.appendAction(AvatarAction.const_332,_loc8_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2432)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2432 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_85 != null && true)
         {
            ...
            this.var_85.x = this.var_1752.x;
            this.var_85.y = this.var_1752.y;
            if(param3 != null)
            {
