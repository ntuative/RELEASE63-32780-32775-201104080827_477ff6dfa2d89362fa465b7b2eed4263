package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      private var var_68:HabboMusicController;
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_68 = param2;
         this.var_717 = [];
         this.var_717.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_717.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_717)
         {
         ...
         this.var_79.addEventListener(RoomEngineSoundMachineEvent.const_687,this.onSoundMachinePlayEvent);
         this.var_79.addEventListener(RoomEngineSoundMachineEvent.const_707,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_79)
            {
               this.var_79.removeEventListener(RoomEngineSoundMachineEvent.const_687,this.onSoundMachinePlayEvent);
               this.var_79.removeEventListener(RoomEngineSoundMachineEvent.const_707,this.onSoundMachineStopEvent);
               this.var_79 = null;
            }
            this._disposed = true;
         }
      ...
      public function checkSongPlayState(param1:int) : void
      {
         ...
         {
            this.playCurrentSongAndNotify(this.var_425);
            _loc2_ = this.getNextEntry();
            if(_loc2_ != null)
            {
               this.var_68.addSongInfoRequest(_loc2_.id);
            }
         }
      }
      ...
      public function stopPlaying() : void
      {
         this.var_425 = -1;
         this.var_608 = false;
         this.var_68.stop(HabboMusicPrioritiesEnum.const_199);
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         while(_loc3_ < this._playListEntries.length)
         {
            ...
            {
               _loc4_ = this.var_68.getSongInfo(param1.id) as SongDataEntry;
               if(_loc4_ != null)
               {
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_68.playSong(param1,HabboMusicPrioritiesEnum.const_199,_loc3_,0,0,0))
         {
