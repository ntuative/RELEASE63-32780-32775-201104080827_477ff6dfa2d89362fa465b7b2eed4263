package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_2510:ITextWindow;
      
      private var var_2511:ITextWindow;
      ...
      {
         if(param1 != this.var_362 || this.var_1187 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1187 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1460)
         {
            this.var_764.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1743)
         {
            this.var_764.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1699)
         {
            this.var_1185.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1660)
         {
            this.setTagError(this.var_919,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_920,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1473)
         {
            this.setTagError(this.var_919,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_920,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         ...
         {
            this.var_764.displayError("Update failed: error " + param2);
         }
      }
      ...
      {
         this.var_764.clearErrors();
         this.var_1185.clearErrors();
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_297,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_559,this.onDoorModePasswordUnselect);
         ...
         this.var_764 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1185 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_919 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_920 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_960 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1183 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1181 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1189 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1184 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_620 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1790 = IWindowContainer(this._window.findChildByName("header_container"));
         this.var_1449 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1188 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1182 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this._switchViewContainer = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1447 = IWindowContainer(this._window.findChildByName("footer_container"));
         ...
         this.var_2510 = ITextWindow(this._window.findChildByName("basic_caption"));
         this.var_2511 = ITextWindow(this._window.findChildByName("advanced_caption"));
         this.var_1448 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1448.mouseThreshold = 0;
         this.var_1448.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1186.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1790.visible = this._inRoom;
         this._switchViewContainer.visible = this._inRoom;
         this.var_2511.visible = this.var_516;
         this.var_2510.visible = !this.var_516;
         if(this.var_516)
         {
            this.var_1182.visible = true;
            this.var_1447.visible = false;
            this.refreshFlatControllers();
            this.var_1182.height = Util.getLowestPoint(this.var_1182) + 4;
         }
         else
         {
            this.populateForm();
            this.var_1188.visible = true;
            this.var_1447.visible = true;
            this.var_1449.visible = this._inRoom;
            this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(this.var_1449.findChildByName("picframe")),this._navigator.data.enteredGuestRoom.thumbnail,false);
            this.var_1188.height = Util.getLowestPoint(this.var_1188) + 4;
         }
         this.var_1448.text = !!this.var_516 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1790.name,this.var_1449.name,this.var_1188.name,this.var_1182.name,this.var_1447.name,this._switchViewContainer.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_764.setText(_loc1_.name);
         this.var_1185.setText(_loc1_.description);
         this.var_960.setText("");
         ...
         {
            case RoomSettingsData.const_200:
         ...
         this.changePasswordField(_loc1_.doorMode == RoomSettingsData.const_115);
         Logger.log("CATEGORY ID: " + _loc1_.categoryId);
         this.setCategorySelection(_loc1_.categoryId);
         this.refreshMaxVisitors(_loc1_);
         this.setTag(this.var_919,_loc1_.tags[0]);
         this.setTag(this.var_920,_loc1_.tags[1]);
         if(this.var_1181)
         {
            if(_loc1_.allowPets)
            {
         ...
         if(this.var_1184)
         {
            ...
            {
               this.var_1184.select();
            }
            else
            {
               this.var_1184.unselect();
            }
         }
         if(this.var_620)
         {
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.allowPets = this.var_1181.isSelected;
         _loc2_.allowFoodConsume = this.var_1189.isSelected;
         _loc2_.allowWalkThrough = this.var_1184.isSelected;
         _loc2_.hideWalls = this.var_620.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_919,_loc2_.tags);
         this.addTag(this.var_920,_loc2_.tags);
         this.clearErrors();
         this.var_1187 = _loc2_.roomId;
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_73,HabboWindowStyle.const_30,HabboWindowParam.const_62,new Rectangle(0,0,100,20)));
      }
