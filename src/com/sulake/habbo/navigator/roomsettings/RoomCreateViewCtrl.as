package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1144:RoomLayout;
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1144.view.findChildByName("select_arrow"));
      ...
      private function prepare() : void
      {
         ...
         this.var_58 = IItemListWindow(this.var_176.findChildByName("item_list"));
         ...
         this.var_1145 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_176.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         this.var_1145.goBackToInitialState();
         this.var_1145.input.textBackgroundColor = 4294967295;
         this.var_1144 = this.var_43[0];
         this.refreshRoomThumbnails();
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_73,HabboWindowStyle.const_30,HabboWindowParam.const_62,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1145.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1145.getText();
         var _loc3_:String = "model_" + this.var_1144.name;
