package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2690 = new RoomThumbnailRenderer(param1);
         this.var_1300 = new TagRenderer(param1,hideInstantly);
      }
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         this.refreshRoomName(this.var_184,this.var_119);
         if(this.var_119.ownerName != "" && this.var_119.ownerName != "-")
         {
         }
         this.refreshOwnerName();
         this.refreshTextWithCaption("roomctg",this.var_184,!!this.var_119.event ? this.getEventCtg(this.var_119.categoryId) : this.getRoomCtg(this.var_119.categoryId));
         this.refreshRoomDesc(this.var_184,this.var_119);
         this.refreshExtraCont();
         this.refreshInfo(this.var_184,"trading_allowed",this.var_119.allowTrading);
         this.refreshInfo(this.var_184,"doormode_doorbell",this.var_119.doorMode == 1);
         this.refreshInfo(this.var_184,"doormode_password",this.var_119.doorMode == 2);
      ...
      {
         this.refreshTextWithCaption("roomowner",this.var_184,this.var_119.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_1300.refreshTags(_loc1_,this.var_119.tags);
         ...
         this.var_2690.refreshThumbnail(_loc1_,this.var_119.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_252,Tabs.const_267,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
