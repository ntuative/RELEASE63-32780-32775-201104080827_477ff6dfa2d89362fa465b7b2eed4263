package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      private static const const_619:int = 2;
      
      private static const const_962:int = 3;
      
      private static const const_1291:int = 4;
      ...
      private var var_903:PopularTagsListCtrl;
      
      private var var_902:GuestRoomListCtrl;
      
      private var var_1106:OfficialRoomListCtrl;
      ...
      public function MainViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_903 = new PopularTagsListCtrl(this._navigator);
         this.var_902 = new GuestRoomListCtrl(this._navigator);
         this.var_1106 = new OfficialRoomListCtrl(this._navigator);
      ...
      private function prepare() : void
      {
         ...
         this.var_1367 = this.var_16.findChildByName("loading_text");
         var _loc1_:IWindow = this.var_16.findChildByTag("close");
         _loc1_.procedure = this.onWindowClose;
         this.var_1107 = IRegionWindow(this.var_16.findChildByName("to_hotel_view"));
         if(!this.var_1107)
         {
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1516,true);
      }
      ...
      public function refresh() : void
      {
         ...
         Util.moveChildrenToColumn(this.var_176,["custom_content","list_content"],this.var_220.y,8);
         this.var_198.height = this.var_198.height + _loc1_ - this.var_198.y - this.var_244.height + this.var_2277;
         Util.moveChildrenToColumn(this.var_176,["list_content","custom_footer"],this.var_198.y,0);
         this.var_2277 = this.var_244.height;
      ...
      {
         this.refreshList(param1,param2,this.var_902,"guest_rooms");
      }
      
      private function refreshPopularTags(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_903,"popular_tags");
      }
      
      private function refreshOfficialRooms(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_1106,"official_rooms");
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_585 == const_961)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_198.blend - _loc2_));
            this.var_198.blend = _loc3_;
            this.var_220.blend = !!this.var_1105 ? Number(_loc3_) : Number(1);
            this.var_244.blend = !!this.var_1105 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               this.var_585 = const_619;
            }
         }
         else if(this.var_585 == const_619)
         {
            if(this.var_1366 % 10 == 1)
            {
            ...
            {
               this.var_585 = const_962;
            }
         }
         else if(this.var_585 == const_962)
         {
            this.refresh();
            this.var_585 = const_1291;
         }
         else
         {
      ...
      {
         this.refreshScrollbar(this.var_903);
         this.refreshScrollbar(this.var_902);
      }
