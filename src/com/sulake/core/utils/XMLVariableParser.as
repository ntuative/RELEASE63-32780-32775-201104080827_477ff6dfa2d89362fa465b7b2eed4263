package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_1606:String = "float";
      
      public static const const_40:String = "Boolean";
      
      public static const const_1496:String = "bool";
      ...
      private static const const_632:String = "key";
      
      private static const TYPE:String = "type";
      
      private static const const_631:String = "value";
      
      private static const const_639:String = "true";
      
      private static const const_1776:String = "false";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         _loc7_ = param1.attribute(const_632);
         if(_loc7_.length() > 0)
         {
            _loc4_ = String(param1.attribute(const_632));
         }
         else
         {
            _loc4_ = param1.child(const_632)[0];
         }
         ...
         _loc7_ = param1.attribute(const_631);
         if(_loc7_.length() > 0)
         {
            _loc6_ = String(param1.attribute(const_631));
         }
         if(_loc6_ != null)
         {
         ...
         {
            _loc8_ = param1.child(const_631)[0];
            if(_loc8_ != null)
            {
            ...
            else if(_loc5_ == const_246 || _loc5_ == const_140)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_156:
               return uint(param1);
            case const_140:
               return param1.split(const_1357);
            default:
