package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1753:uint = 1;
      
      protected static const const_1754:uint = 2;
      
      protected static const const_1752:uint = 4;
      
      protected static const const_1751:uint = 3;
      
      protected static const name_4:uint = 7;
      
      public static const const_1710:int = 5;
      
      public static const LIBRARY_LOADER_FINALIZE:String = "LIBRARY_LOADER_FINALIZE";
      
      public static const const_1139:Boolean = false;
      
      public static const const_1744:int = 2;
      
      private static var var_1053:Array = new Array();
      ...
      protected var var_2955:uint = 0;
      
      protected var var_2887:Boolean = true;
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1139)
         {
            ...
            while(var_850.length < const_1744 && false)
            {
               _loc1_ = var_1053.shift() as LibraryLoader;
      ...
      {
         return !!this.var_1071 ? uint(this.var_1323 - this.var_2110) : uint(getTimer() - this.var_2110);
      }
      ...
      public function resume() : void
      {
         ...
         {
            this.var_1070 = false;
            if(!this.var_1071 && this.var_240)
            {
               this.var_1323 = -1;
               this.var_2110 = getTimer();
               queue(this);
            }
         }
      }
      ...
      {
         if(!this.var_1071 && !_disposed && this.var_1324 > 0)
         {
            try
            {
               this.var_42.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_240,const_1710 - this.var_1324);
            if(this.var_2887)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         if(this.var_474 == LibraryLoader.const_1751)
         {
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_664 = this.getDefinition(this._name) as Class;
         ...
         try
         {
            xmlClass = this.var_664.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
