package com.sulake.core.utils
{
   public class ErrorReportStorage
   {
      ...
      private static var var_1253:Map = new Map();
      
      private static var var_813:Map = new Map();
      ...
      public static function getDebugData() : String
      {
         ...
         while(_loc2_ < var_813.length)
         {
            if(_loc2_ == 0)
            {
               _loc1_ = var_813.getWithIndex(_loc2_);
            }
            else
            {
               _loc1_ = _loc1_ + " ** " + var_813.getWithIndex(_loc2_);
            }
            _loc2_++;
         }
