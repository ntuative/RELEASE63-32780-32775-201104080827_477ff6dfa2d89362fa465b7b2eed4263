package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1485:int = 10000;
      ...
      private var var_512:ByteArray;
      
      private var var_1168:IEncryption;
      
      private var var_759:IProtocol;
      
      private var _id:String;
      
      private var var_1167:IMessageClassManager;
      
      private var var_293:ICoreCommunicationManager;
      
      private var var_513:IConnectionStateListener;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this._id = param1;
         this.var_293 = param2;
         this.var_512 = new ByteArray();
         this.var_1167 = new MessageClassManager();
         this.var_78 = new Socket();
         this.var_359 = new Timer(const_1485,1);
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(this.var_513)
         {
            this.var_513.connectionInit(param1,param2);
         }
         Security.loadPolicyFile("xmlsocket://" + param1 + ":" + param2);
         this.var_359.start();
         this.var_758 = getTimer();
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_1167.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
         ...
         if(this.var_513)
         {
            this.var_513.messageSent(String(_loc4_),_loc5_.toString());
         }
         if(this.var_1168 != null)
         {
            _loc3_ = this.var_1168.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      {
         this.var_1167.registerMessages(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         return _loc1_ + ("Encryption: " + this.var_1168 + "\n");
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_759.getMessages(this.var_512,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               if(this.var_513)
               {
                  this.var_513.messageReceived(String(id),data.toString());
               }
               eventClasses = this.var_1167.getMessageEventClasses(id);
               events = new Array();
            ...
            {
               temp = new ByteArray();
               temp.writeBytes(this.var_512,offset);
               this.var_512 = temp;
               this.logConnection("[SOCKET REST] offset: " + offset + " rest: " + this.var_512.toString());
            }
         }
         catch(e:Error)
         {
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_512.writeByte(this.var_78.readUnsignedByte());
         }
      }
      ...
      private function onConnect(param1:Event) : void
      {
         ...
         this.var_359.stop();
         this.var_1777 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - this.var_758));
      ...
      private function onClose(param1:Event) : void
      {
         ...
         this.var_1777 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - this.var_758));
         dispatchEvent(param1);
      }
      ...
      private function onComplete(param1:Event) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - this.var_758));
         dispatchEvent(param1);
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - this.var_758));
         dispatchEvent(param1);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - this.var_758));
         switch(param1.type)
         {
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - this.var_758));
