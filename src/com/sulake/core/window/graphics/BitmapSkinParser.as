   ...
   public class BitmapSkinParser
   {
      ...
      protected static function parseLayout(param1:ISkinRenderer, param2:XML, param3:Dictionary, param4:Map) : void
      {
         ...
         if(_loc10_.length() > 0)
         {
            ...
            if(_loc12_.length())
            {
               method_6(param1,_loc9_,_loc12_,param4);
            }
         }
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_394 = SkinLayoutEntity.const_547;
                  break;
               case "move":
                  _loc5_.var_394 = SkinLayoutEntity.const_333;
                  break;
               case "strech":
                  _loc5_.var_394 = SkinLayoutEntity.const_459;
                  break;
               case "tiled":
                  _loc5_.var_394 = SkinLayoutEntity.const_340;
                  break;
               case "center":
                  _loc5_.var_394 = SkinLayoutEntity.const_1180;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_396 = SkinLayoutEntity.const_547;
                  break;
               case "move":
                  _loc5_.var_396 = SkinLayoutEntity.const_333;
                  break;
               case "strech":
                  _loc5_.var_396 = SkinLayoutEntity.const_459;
                  break;
               case "tiled":
                  _loc5_.var_396 = SkinLayoutEntity.const_340;
                  break;
               case "center":
                  _loc5_.var_396 = SkinLayoutEntity.const_1180;
            }
         }
      ...
      protected static function method_6(param1:ISkinRenderer, param2:SkinLayout, param3:XMLList, param4:Map) : void
      {
         var _loc5_:* = null;
         var _loc6_:int = 0;
