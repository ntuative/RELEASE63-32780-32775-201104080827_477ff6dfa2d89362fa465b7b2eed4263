package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1956:uint = 64;
      ...
      public function setDrawRegion(param1:Rectangle, param2:Boolean, param3:Rectangle) : void
      {
         ...
         if(param3)
         {
            if(!this.var_192)
            {
               this.var_192 = new Shape();
               this.var_192.visible = false;
               this.var_192.cacheAsBitmap = true;
               super.addChild(this.var_192);
            }
            this.var_192.graphics.clear();
            this.var_192.graphics.beginFill(255);
            this.var_192.graphics.drawRect(param3.x,param3.y,param3.width,param3.height);
            this.var_192.graphics.endFill();
            this.getDisplayObject().mask = this.var_192;
         }
         else if(this.var_192)
         {
            super.removeChild(this.var_192);
            this.var_192.graphics.clear();
            this.var_192 = null;
