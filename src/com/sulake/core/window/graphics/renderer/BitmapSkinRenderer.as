   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            if(_loc16_)
            {
               this.var_806.redMultiplier = ((param1.color & 16711680) >> 16) / 255;
               this.var_806.greenMultiplier = ((param1.color & 65280) >> 8) / 255;
               this.var_806.blueMultiplier = (param1.color & 255) / 255;
            ...
            while(_loc17_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc16_ && _loc10_.colorize)
                  {
                     ...
                     _loc18_.colorTransform(_loc18_.rect,this.var_806);
                  }
                  _loc12_ = false;
                  _loc13_ = false;
                  ...
                  if(_loc10_.var_394 == SkinLayoutEntity.const_333)
                  {
                     var_28.x += _loc14_;
                  }
                  else if(_loc10_.var_394 == SkinLayoutEntity.const_459)
                  {
                     _loc12_ = true;
                  ...
                  else if(_loc10_.var_394 == SkinLayoutEntity.const_340)
                  {
                     _loc12_ = true;
                     var_28.right += _loc14_;
                     if(true)
                  ...
                  if(_loc10_.var_396 == SkinLayoutEntity.const_333)
                  {
                     var_28.y += _loc15_;
                  }
                  else if(_loc10_.var_396 == SkinLayoutEntity.const_459)
                  {
                     _loc13_ = true;
                  ...
                  else if(_loc10_.var_396 == SkinLayoutEntity.const_340)
                  {
                     _loc13_ = true;
                     var_28.bottom += _loc15_;
                     if(true)
                  ...
                  else if(_loc10_.var_396 == SkinLayoutEntity.const_340 || _loc10_.var_394 == SkinLayoutEntity.const_340)
                  {
                  ...
                  {
                     this.var_266.a = var_28.width;
                     this.var_266.d = var_28.height;
                     this.var_266.tx = var_28.x;
                     this.var_266.ty = var_28.y;
                     ALPHA.alphaMultiplier = (_loc19_.getPixel32(0,0) >>> 24) / 255;
                     _loc6_.draw(_loc18_,this.var_266,ALPHA);
                  }
                  else
                  {
                     this.var_266.a = 0 / _loc18_.width;
                     this.var_266.d = 0 / _loc18_.height;
                     this.var_266.tx = 0;
                     this.var_266.ty = 0;
                     _loc31_ = new BitmapData(var_28.width,var_28.height,_loc18_.transparent);
                     _loc31_.draw(_loc18_,this.var_266);
                     _loc32_ = new BitmapData(var_28.width,var_28.height,true,0);
                     _loc32_.draw(_loc19_,this.var_266,null);
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:SkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.var_394 == SkinLayoutEntity.const_333)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.var_396 == SkinLayoutEntity.const_333)
               {
