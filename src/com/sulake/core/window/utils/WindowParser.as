package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1818:String = "_INCLUDE";
      
      public static const const_1987:String = "_TEMP";
      
      private static const const_1402:String = "layout";
      
      private static const const_1000:String = "window";
      
      private static const const_999:String = "variables";
      
      private static const const_1001:String = "filters";
      
      private static const const_436:String = "name";
      
      private static const const_1404:String = "style";
      
      private static const const_638:String = "params";
      
      private static const const_1408:String = "tags";
      ...
      private static const const_1395:String = "visible";
      ...
      private static const const_1197:String = "blend";
      
      private static const const_1401:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1397:String = "treshold";
      
      private static const const_1400:String = "children";
      
      private static const const_1396:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1407:String = "height_min";
      
      private static const const_1398:String = "height_max";
      
      private static const const_639:String = "true";
      
      private static const const_162:String = "0";
      
      private static const const_1406:String = "$";
      
      private static const const_1357:String = ",";
      
      private static const const_49:String = "";
      
      private static const const_1399:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1403:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1321:Dictionary;
      
      protected var var_1320:Dictionary;
      
      protected var var_1067:Dictionary;
      
      protected var var_1587:Dictionary;
      
      protected var var_2106:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1321,this.var_1320);
         this.var_1067 = new Dictionary();
         this.var_1587 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1067,this.var_1587);
         this.var_2106 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1403,const_49);
         return param1.replace(const_1399,const_49);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1320)
            {
               delete this.var_1320[_loc1_];
            }
            for(_loc1_ in this.var_1067)
            {
               delete this.var_1067[_loc1_];
            }
            for(_loc1_ in this.var_1587)
            {
               delete this.var_1587[_loc1_];
            }
            this.var_2106.dispose();
            this.var_2106 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1402)
         {
            _loc8_ = param1.child(const_999);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1001).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1321[xml.localName()];
         ...
         params = uint(this.parseAttribute(xml,const_638,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1408,variables,tag)));
         rect = new Rectangle();
         ...
         visible = this.parseAttribute(xml,const_1395,variables,visible.toString()) == const_639;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_638).length() > 0)
         {
            list = xml.child(const_638).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_999)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1396,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1407,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1398,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_639;
         blend = Number(this.parseAttribute(xml,const_1197,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1401,variables,window.clipping.toString()) == const_639;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1397,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_1001).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_49;
         var _loc3_:String = this.var_1320[param1.type];
