package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static const const_621:String = "{";
      
      private static const const_620:String = "}";
      
      private static const const_1295:String = "/*";
      
      private static const const_1296:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_83[const_209],var_83[ITALIC],var_83[BOLD]];
            var_83.reset();
            var_83[const_209] = _loc5_[0];
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_620);
         if(countSubStrings(param1,const_621) != countSubStrings(param1,const_620))
         {
            throw new Error("Mismatching amount of \"" + const_621 + "\" versus \"" + const_620 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1295) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1296) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_621)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
