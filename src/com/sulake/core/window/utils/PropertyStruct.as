package com.sulake.core.window.utils
{
   ...
   public class PropertyStruct
   {
      ...
      public function PropertyStruct(param1:String, param2:Object, param3:String, param4:Boolean, param5:Array = null)
      {
         ...
         this.var_2925 = param3 == const_246 || param3 == const_140 || param3 == const_245 || param3 == const_250;
         this.var_2802 = param5;
      }
      ...
      public function toXMLString() : String
      {
         ...
         switch(this._type)
         {
            ...
            case const_250:
               ...
               break;
            case const_156:
               _loc1_ = "<var key=\"" + this.var_669 + "\" value=\"" + "0x" + uint(this.var_188).toString(16) + "\" type=\"" + this._type + "\" />";
               break;
            default:
               _loc1_ = "<var key=\"" + this.var_669 + "\" value=\"" + this.var_188 + "\" type=\"" + this._type + "\" />";
         }
         return _loc1_;
      }
   }
