package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      private var var_302:int = 2.147483647E9;
      ...
      {
         this.var_303 = param1;
         if(this.var_303 < int.MAX_VALUE && !this._target.disposed && this._target.width > this.var_303)
         {
      ...
      {
         this.var_302 = param1;
         if(this.var_302 < int.MAX_VALUE && !this._target.disposed && this._target.height > this.var_302)
         {
      ...
      {
         return this.var_304 == int.MIN_VALUE && this.var_303 == int.MAX_VALUE && this.var_301 == int.MIN_VALUE && this.var_302 == int.MAX_VALUE;
      }
      ...
      public function limit() : void
      {
         if(!this.isEmpty && this._target)
         {
            ...
            else if(this._target.width > this.var_303)
            {
               this._target.width = this.var_303;
            }
            ...
            else if(this._target.height > this.var_302)
            {
               this._target.height = this.var_302;
            }
         }
