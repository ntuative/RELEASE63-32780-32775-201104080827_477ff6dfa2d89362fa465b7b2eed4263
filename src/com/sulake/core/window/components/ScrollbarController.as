package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1340:String = "increment";
      
      private static const const_1341:String = "decrement";
      
      private static const const_979:String = "slider_track";
      
      private static const const_628:String = "slider_bar";
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(this.var_17 != null && !this.var_17.disposed)
         {
            ...
            this.var_17.removeEventListener(WindowEvent.const_580,this.onScrollableScrolled);
         }
         this.var_17 = param1;
         if(this.var_17 != null && !this.var_17.disposed)
         {
            this.var_17.addEventListener(WindowEvent.const_38,this.onScrollableResized);
            this.var_17.addEventListener(WindowEvent.const_580,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_961 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      {
         return findChildByName(const_979) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_628) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_628:
         ...
         if(param2.type == WindowEvent.const_650)
         {
            if(this.var_17 == null)
            {
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_45 || param1.type == WindowTouchEvent.const_792)
         {
            ...
            else if(param2.name == const_1341)
            {
               if(this.var_17)
               {
                  this.var_1190 = true;
            ...
            else if(param2.name == const_979)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_628).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_961) as IScrollableWindow;
            if(_loc1_ == null && _parent is IWindowContainer)
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_961) as IScrollableWindow;
               if(_loc1_)
               {
