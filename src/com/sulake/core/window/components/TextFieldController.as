package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_771 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_780,false,PropertyStruct.const_40,true) : PropertyDefaults.const_1709);
         _loc1_.push(this.var_1312 != PropertyDefaults.const_1165 ? new PropertyStruct(PropertyDefaults.const_800,this.var_1312,PropertyStruct.const_40,true) : PropertyDefaults.const_1683);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1031 ? new PropertyStruct(PropertyDefaults.const_873,_field.selectable,PropertyStruct.const_40,true) : PropertyDefaults.const_1672);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1231 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_40,true) : PropertyDefaults.const_1570);
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_800:
                  this.var_1312 = _loc2_.value as Boolean;
                  if(this.var_1312)
                  {
