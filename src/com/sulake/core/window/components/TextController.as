package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_421,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_421 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_421,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_673 ? true : null;
         }
      ...
      {
         return new Rectangle(this.var_861 * this.maxScrollH,this.var_562 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_1103) ? new PropertyStruct(PropertyDefaults.const_886,this._field.antiAliasType,PropertyStruct.const_55,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_1080) : PropertyDefaults.const_1597);
         _loc1_.push(this._autoSize != PropertyDefaults.const_1096 ? new PropertyStruct(PropertyDefaults.const_685,this._autoSize,PropertyStruct.const_55,true,PropertyDefaults.const_1207) : PropertyDefaults.const_1680);
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1118 ? new PropertyStruct(PropertyDefaults.const_1134,this._field.gridFitType,PropertyStruct.const_55,true,PropertyDefaults.const_1158) : PropertyDefaults.const_1588);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_648) ? new PropertyStruct(PropertyDefaults.const_428,this._field.textColor,PropertyStruct.const_156,true) : PropertyDefaults.const_1108);
         ...
         _loc1_.push(this.var_41.left != PropertyDefaults.const_712 ? new PropertyStruct(PropertyDefaults.const_282,this.var_41.left,PropertyStruct.const_42,true) : PropertyDefaults.const_456);
         _loc1_.push(this.var_41.top != PropertyDefaults.const_721 ? new PropertyStruct(PropertyDefaults.const_281,this.var_41.top,PropertyStruct.const_42,true) : PropertyDefaults.const_555);
         _loc1_.push(this.var_41.right != PropertyDefaults.const_663 ? new PropertyStruct(PropertyDefaults.const_266,this.var_41.right,PropertyStruct.const_42,true) : PropertyDefaults.const_560);
         _loc1_.push(this.var_41.bottom != PropertyDefaults.const_938 ? new PropertyStruct(PropertyDefaults.const_242,this.var_41.bottom,PropertyStruct.const_42,true) : PropertyDefaults.const_445);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1125 ? new PropertyStruct(PropertyDefaults.const_831,this._field.mouseWheelEnabled,PropertyStruct.const_40,true) : PropertyDefaults.const_1557);
