package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      override public function dispose() : void
      {
         if(this.var_415)
         {
            this.var_415.removeEventListener(WindowEvent.const_237,this.scrollBarEventProc);
            this.var_415.removeEventListener(WindowEvent.const_203,this.scrollBarEventProc);
            this.var_415 = null;
         }
         if(this.var_1125)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1125)
         {
            this.var_1125 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_415)
         {
            ...
            if(this.var_415)
            {
               this.var_415.addEventListener(WindowEvent.const_237,this.scrollBarEventProc);
               this.var_415.addEventListener(WindowEvent.const_203,this.scrollBarEventProc);
            }
         }
         return this.var_415;
      }
