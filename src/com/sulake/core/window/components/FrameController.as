package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1306:String = "_TITLE";
      
      private static const const_1305:String = "_HEADER";
      
      private static const const_1303:String = "_CONTENT";
      
      private static const const_1304:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1398:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1306) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1398 = findChildByTag(const_1305) as IHeaderWindow;
            if(!this.var_1398)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_176 = findChildByTag(const_1303) as IWindowContainer;
            if(!this.var_176)
            {
      ...
      {
         return findChildByTag(const_1304) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1259,_loc2_,false);
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_282,_loc3_.left,PropertyStruct.const_42,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_281,_loc3_.top,PropertyStruct.const_42,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_266,0 - _loc3_.right,PropertyStruct.const_42,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_242,0 - _loc3_.bottom,PropertyStruct.const_42,_loc2_));
         }
         else
         {
