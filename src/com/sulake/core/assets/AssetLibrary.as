package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_781:String = "AssetLibraryLoaded";
      
      public static const const_1469:String = "AssetLibraryUnloaded";
      
      public static const const_1477:String = "AssetLibraryLoadError";
      
      private static const const_436:String = "name";
      
      private static const const_1013:String = "asset";
      
      private static const const_1011:String = "param";
      
      private static const TYPE:String = "mimeType";
      
      private static const const_1012:String = "library";
      
      private static var var_320:Dictionary;
      
      private static var var_1964:LazyAssetProcessor = new LazyAssetProcessor();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         this.var_1024 = new Dictionary(false);
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         var _loc5_:XMLList = param2.child(const_1012);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1013);
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_1011);
                  if(_loc11_.length())
                  {
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_1025.splice(var_1025.indexOf(this),1);
            --var_544;
            this.var_545 = null;
            this.var_1024 = null;
            this.var_166 = null;
      ...
      public function loadFromFile(param1:LibraryLoader, param2:Boolean = true) : void
      {
         ...
         {
            if(!this.var_1022 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_664);
            }
      ...
      public function unload() : void
      {
         ...
         this.var_1023 = false;
         this.var_663 = null;
         dispatchEvent(new Event(AssetLibrary.const_1469));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_1024[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_29:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++this.var_454;
                     this.var_453.push(struct.assetName);
                  }
      ...
      {
         return param1 < this.var_453.length ? this.getAssetByName(this.var_453[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_166)
         {
            ...
            {
               return this.var_453.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_166[param1] != null || (this.var_664 != null ? this.var_664[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_1964.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_166)
            {
               if(this.var_166[_loc2_] == param1)
               {
                  this.var_453.splice(this.var_453.indexOf(_loc2_),1);
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_1023 = true;
         dispatchEvent(new Event(AssetLibrary.const_781));
         dispatchEvent(new Event(AssetLibrary.const_1242));
         if(this.var_1022)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1477));
         this.var_42 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1012);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1013);
            _loc5_ = null;
            ...
            while(_loc8_ < _loc7_)
            {
               ...
               if(_loc3_.attribute(const_436).toString() == param1)
               {
                  ...
                  _loc5_.setUnknownContent(this.var_664[param1]);
                  _loc6_ = _loc3_.child(const_1011);
                  if(_loc6_.length())
                  {
