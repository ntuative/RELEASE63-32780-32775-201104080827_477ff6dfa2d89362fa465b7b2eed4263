package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      {
         super();
         this.var_1061 = param2 == null ? "" : param2.url;
         this._type = param1;
         this.var_42 = new Loader();
         this.var_1060 = new LoaderContext();
         this.var_1060.checkPolicyFile = true;
         ...
         {
            this.var_42.load(param2,this.var_1060);
         }
      }
      ...
      {
         this.var_1061 = param1.url;
         var_329 = 0;
         this.var_42.load(param1,this.var_1060);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_329 < var_2872)
            {
               ...
               this.var_42.load(new URLRequest(this.var_1061 + (this.var_1061.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_329),this.var_1060);
               return true;
            }
         }
         return false;
