   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_101 is BitmapDataAsset)
         {
            ...
            this.var_1424 = BitmapDataAsset(this.var_101).var_1424;
            this.var_1425 = BitmapDataAsset(this.var_101).var_1425;
            if(this._bitmap != null)
            {
               this.var_101 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1424 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1425 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
