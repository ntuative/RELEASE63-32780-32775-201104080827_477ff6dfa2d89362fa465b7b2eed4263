package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1447:String = "asset-libraries";
      
      private static const const_1443:String = "library";
      
      private static const const_1445:String = "service-libraries";
      
      private static const const_1441:String = "library";
      
      private static const const_1448:String = "component-libraries";
      
      private static const const_1442:String = "library";
      
      private static const const_1449:String = "error_data";
      
      private static const const_1446:String = "error_cat";
      
      private static const const_1444:String = "error_desc";
       
      
      private var var_390:LibraryLoaderQueue;
      
      private var var_849:IEventDispatcher;
      
      private var var_557:uint;
      
      private var var_391:Function;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         switch(param2 & 0)
         {
            case Core.const_1244:
               ...
               this.var_391 = this.simpleFrameUpdateHandler;
               break;
            case Core.const_694:
               debug("Core; using complex frame update handler");
               this.var_391 = this.complexFrameUpdateHandler;
               break;
            case Core.const_818:
               debug("Core; using profiler frame update handler");
               this.var_391 = this.profilerFrameUpdateHandler;
               this.var_212 = new Profiler(this);
               attachComponent(this.var_212,[new IIDProfiler()]);
               var_397.addChild(new ProfilerViewer(this.var_212));
               break;
            case Core.const_558:
               debug("Core; using experimental frame update handler");
               this.var_391 = this.experimentalFrameUpdateHandler;
               break;
            case Core.CORE_SETUP_DEBUG:
               debug("Core; using debug frame update handler");
               this.var_391 = this.debugFrameUpdateHandler;
         }
      }
      
      public function getNumberOfFilesPending() : uint
      {
         return this.var_390.length;
      }
      
      public function getNumberOfFilesLoaded() : uint
      {
         return this.var_557 - this.getNumberOfFilesPending();
      }
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         ...
         ErrorReportStorage.setParameter(const_1444,param1);
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         this.var_849 = loadingEventDelegate;
         if(this.var_390 == null)
         {
            this.var_390 = new LibraryLoaderQueue(_debug);
         }
         try
         {
            node = config.child(const_1447)[0];
            if(node != null)
            {
               list = node.child(const_1443);
         ...
         {
            error("Failed to parse asset libraries from config xml!",true,Core.const_331,e);
         }
         try
         {
         ...
         {
            error("Failed to parse interfaces from config xml!",true,Core.const_331,e);
         }
         try
         {
         ...
         {
            error("Failed to parse components from config xml!",true,Core.const_331,e);
         }
         if(!disposed)
         {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_849)
         {
            this.var_849.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_849)
         {
            ...
            this.var_849.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_849)
                  {
                     this.var_849.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_557 - this.var_390.length,this.var_557,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:int = !!this.var_212 ? 0 : this.var_1574 & 0;
         if(_loc3_ == Core.const_558)
         {
      ...
      private function onEnterFrame(param1:Event) : void
      {
         ...
         this.var_391(_loc2_,_loc2_ - this._lastUpdateTimeMs);
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         while(priority < CoreComponentContext.const_103)
         {
            ...
            {
               if(this.var_681[priority] < priority)
               {
                  ++this.var_681[priority];
                  skip = true;
               }
            }
            if(!skip)
