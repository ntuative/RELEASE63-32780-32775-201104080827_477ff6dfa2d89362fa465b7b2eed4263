package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_2950:IRoomContentLoader;
      
      private var var_645:IRoomObjectFactory = null;
      
      private var var_530:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_1238:XML = null;
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_645 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_645 == null || this.var_530 == null)
         {
            return;
         }
         this._state = const_1608;
         if(this.var_1238 != null)
         {
            _loc1_ = this.var_1238;
            this.var_1238 = null;
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_643.indexOf(_loc5_) < 0)
            {
               this.var_55.loadObjectContent(_loc5_,events);
               this.var_643.push(_loc5_);
            }
            _loc4_++;
         }
         this._state = const_1199;
         return true;
      }
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         var _loc4_:int = this.var_644.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_644[_loc4_];
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_530.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_530.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_645.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_645 != null)
         {
            return this.var_645.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this.var_55.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = this.var_643.indexOf(param1);
            if(_loc2_ >= 0)
            {
               this.var_643.splice(_loc2_,1);
            }
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         while(this.var_993.length > 0)
         {
            _loc2_ = this.var_993[0];
            this.var_993.splice(0,1);
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_55 == null || this.var_530 == null)
         {
            return;
         }
         ...
         var _loc7_:IRoomObjectVisualizationData = this.var_530.getRoomObjectVisualizationData(param1,_loc5_,_loc2_);
         var _loc8_:int = this.var_118.length - 1;
         while(_loc8_ >= 0)
         {
            _loc9_ = this.var_118.getWithIndex(_loc8_) as RoomInstance;
            _loc10_ = this.var_118.getKey(_loc8_);
            if(_loc9_ != null)
            {
               ...
               for each(_loc12_ in _loc11_)
               {
                  ...
                  while(_loc14_ >= 0)
                  {
                     ...
                     if(_loc15_ != null)
                     {
                        _loc16_ = this.var_530.createRoomObjectVisualization(_loc5_);
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              _loc17_ = this.var_645.createRoomObjectLogic(_loc6_);
