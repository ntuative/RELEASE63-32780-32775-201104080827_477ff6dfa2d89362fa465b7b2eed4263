package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_695:Number = 64;
      
      public static const const_1210:Number = 32;
      ...
      private var var_2902:Number = -500.0;
      
      private var var_2901:Number = 500.0;
      
      private var var_270:Number;
      ...
      {
         this.var_1737.assign(this.var_148);
         return this.var_1737;
      }
      
      public function get location() : IVector3d
      {
         this.var_506.assign(this.var_92);
         this.var_506.x *= this.var_423;
         this.var_506.y *= this.var_422;
         this.var_506.z *= this.var_424;
         return this.var_506;
      }
      
      public function get direction() : IVector3d
      {
         this._direction.assign(this.var_353);
         return this._direction;
      }
      
      public function set x_scale(param1:Number) : void
      {
         if(this.var_423 != param1 * this.var_1740)
         {
            this.var_423 = param1 * this.var_1740;
            ++this.var_156;
         }
      }
      ...
      {
         if(this.var_422 != param1 * this.var_1738)
         {
            this.var_422 = param1 * this.var_1738;
            ++this.var_156;
         }
      }
      ...
      {
         if(this.var_424 != param1 * this.var_1739)
         {
            this.var_424 = param1 * this.var_1739;
            ++this.var_156;
         }
      }
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_353.x;
         var _loc3_:Number = this.var_353.y;
         var _loc4_:Number = this.var_353.z;
         this.var_353.assign(param1);
         if(this.var_353.x != _loc2_ || this.var_353.y != _loc3_ || this.var_353.z != _loc4_)
         {
            ++this.var_156;
         }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_507 != null)
         {
            ...
            this.var_507.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_507.add(_loc3_,_loc4_);
            ++this.var_156;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_507 != null)
         {
            ...
            return this.var_507.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1146.assign(_loc22_);
         }
         else
         {
            this.var_1146.assign(_loc17_);
         }
         ++this.var_156;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1146);
         if(_loc3_ < this.var_2902 || _loc3_ > this.var_2901)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_422;
            _loc2_.z *= this.var_424;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1146);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1210;
         }
         else
         {
            this.scale = const_695;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_695;
      }
